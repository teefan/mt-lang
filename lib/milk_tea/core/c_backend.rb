...
module MilkTea
  ...
  class CBackend
    ...
    def emit_preamble(lines)
      ...
      if uses_fatal_helper? || uses_format_helpers? || uses_async_memory_helpers? || uses_foreign_temp_cstr_helpers? || uses_detach_helper? || uses_cyclic_variant_heap_copy? || uses_str_concat_helper?
        headers << "<stdlib.h>"
      end
