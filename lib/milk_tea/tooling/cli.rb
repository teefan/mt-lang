...
module MilkTea
  class CLI
    ...
    def format_command
      ...
      if options[:ignore_generated] && generated_source?(source)
        @out.puts("ignored generated #{path}")
        return 0
      end
    ...
    def format_paths(paths, options)
      ...
      if options[:check]
        ...
        paths.each do |p|
          ...
          result = Formatter.check_source(source, path: p, mode: options[:mode], max_line_length: options[:max_line_length])
          needs_fmt << p if result.changed
        end
        if needs_fmt.empty?
          @out.puts("all #{paths.size - skipped_generated} file(s) already formatted")
          @out.puts("skipped #{skipped_generated} generated file(s)") if skipped_generated.positive?
          return 0
        end
      ...
      @out.puts("formatted #{changed} of #{paths.size - skipped_generated} file(s)")
      @out.puts("skipped #{skipped_generated} generated file(s)") if skipped_generated.positive?
      0
    end
      ...
      "format"          => <<~HELP,
        Usage: mtc format PATH|DIR [PATH|DIR ...] [OPTIONS]
          ...
          Options:
            ...
            --ignore-generated
                             Skip files that start with '# generated by mtc'.
