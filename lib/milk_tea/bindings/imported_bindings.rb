    ...
    class Generator
      ...
      def generate
        ...
        sections = [
          ...
          emit_methods(method_specs, function_entries, declarations),
        ].reject(&:empty?)
      ...
      def emit_methods(method_specs, function_entries, declarations)
      ...
      def normalize_method_specs(value)
        ...
        value.map do |entry|
          ...
          validate_allowed_keys!(entry, %w[type receiver_types include include_prefixes exclude rename_rules strip_prefix], context: "methods entry")
      ...
      def render_method_wrapper(function_entry, spec:)
        ...
        call_expression = build_call_expression(function_entry.fetch(:public_name), type_params: function_entry.fetch(:type_params), args: call_args)
