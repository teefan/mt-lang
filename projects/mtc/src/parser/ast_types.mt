...
public variant Decl:
    ...
    const_decl(name: str, ctype: str, has_block_body: bool, is_const_fn: bool, head_start: ptr_uint, head_end: ptr_uint, body_start: ptr_uint, body_end: ptr_uint)
    ...
    when_block(discriminant_line: str, head_start: ptr_uint, head_end: ptr_uint, body_start: ptr_uint, body_end: ptr_uint)
