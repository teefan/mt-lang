...
function main() -> int:
    ...
    while not rl.window_should_close():
        ...
        let btn_random_pressed = gui.button(
            gui.Rectangle(x = 710.0, y = 120.0, width = 40.0, height = 40.0),
            "#77#"
        ) != 0
        let btn_cut_pressed = gui.button(
            gui.Rectangle(x = 50.0, y = 180.0, width = 158.0, height = 40.0),
            "#17#CUT"
        ) != 0
        let btn_copy_pressed = gui.button(
            gui.Rectangle(x = 215.0, y = 180.0, width = 158.0, height = 40.0),
            "#16#COPY"
        ) != 0
        let btn_paste_pressed = gui.button(
            gui.Rectangle(x = 380.0, y = 180.0, width = 158.0, height = 40.0),
            "#18#PASTE"
        ) != 0
        let btn_clear_pressed = gui.button(
            gui.Rectangle(x = 545.0, y = 180.0, width = 158.0, height = 40.0),
            "#143#CLEAR"
        ) != 0
        ...
        gui.label(
            gui.Rectangle(x = 50.0, y = 360.0, width = 700.0, height = 40.0),
