...
def main() -> i32:
    ...
    while not rl.WindowShouldClose():
        ...
        for index in range(0, 15):
            draw_keyboard_key(
                rl.Rectangle(x = keyboard_offset.x + rec_offset_x, y = keyboard_offset.y, width = 1.0 * line01_widths[index], height = 30.0),
                line01_keys[index],
            )
