...
function main() -> int:
    ...
    while not rl.window_should_close():
        ...
        gui.slider_bar(rl.Rectangle(x = 600.0, y = 40.0, width = 120.0, height = 20.0), "StartAngle", text.cstr_as_str(rl.text_format("%.2f", start_angle)), start_angle, -450.0, 450.0)
        gui.slider_bar(rl.Rectangle(x = 600.0, y = 70.0, width = 120.0, height = 20.0), "EndAngle", text.cstr_as_str(rl.text_format("%.2f", end_angle)), end_angle, -450.0, 450.0)
        gui.slider_bar(rl.Rectangle(x = 600.0, y = 140.0, width = 120.0, height = 20.0), "InnerRadius", text.cstr_as_str(rl.text_format("%.2f", inner_radius)), inner_radius, 0.0, 100.0)
        gui.slider_bar(rl.Rectangle(x = 600.0, y = 170.0, width = 120.0, height = 20.0), "OuterRadius", text.cstr_as_str(rl.text_format("%.2f", outer_radius)), outer_radius, 0.0, 200.0)
        gui.slider_bar(rl.Rectangle(x = 600.0, y = 240.0, width = 120.0, height = 20.0), "Segments", text.cstr_as_str(rl.text_format("%.2f", segments)), segments, 0.0, 100.0)
