...
def main() -> i32:
    ...
    while not rl.WindowShouldClose():
        ...
        gui.GuiCheckBox(gui.Rectangle(x = 640.0, y = 320.0, width = 20.0, height = 20.0), c"DrawRoundedRect", raw(addr(draw_rounded_rect)))
        gui.GuiCheckBox(gui.Rectangle(x = 640.0, y = 350.0, width = 20.0, height = 20.0), c"DrawRoundedLines", raw(addr(draw_rounded_lines)))
        gui.GuiCheckBox(gui.Rectangle(x = 640.0, y = 380.0, width = 20.0, height = 20.0), c"DrawRect", raw(addr(draw_rect)))
