...
def main() -> i32:
    ...
    while not rl.WindowShouldClose():
        ...
        gui.GuiSliderBar(gui.Rectangle(x = 600.0, y = 140.0, width = 120.0, height = 20.0), c"InnerRadius", rl.TextFormat(c"%.2f", inner_radius), raw(addr(inner_radius)), 0.0, 100.0)
        gui.GuiSliderBar(gui.Rectangle(x = 600.0, y = 170.0, width = 120.0, height = 20.0), c"OuterRadius", rl.TextFormat(c"%.2f", outer_radius), raw(addr(outer_radius)), 0.0, 200.0)
        gui.GuiSliderBar(gui.Rectangle(x = 600.0, y = 240.0, width = 120.0, height = 20.0), c"Segments", rl.TextFormat(c"%.2f", segments), raw(addr(segments)), 0.0, 100.0)

        gui.GuiCheckBox(gui.Rectangle(x = 600.0, y = 320.0, width = 20.0, height = 20.0), c"Draw Ring", raw(addr(draw_ring)))
