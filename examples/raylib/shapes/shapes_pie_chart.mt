...
def main() -> i32:
    ...
    while not rl.WindowShouldClose():
        ...
        gui.GuiSpinner(gui.Rectangle(x = panel_pos_x + 95.0, y = panel_pos_y + 12.0, width = 125.0, height = 25.0), slices_text, ptr_of(slice_count), 1, max_pie_slices, false)
        gui.GuiCheckBox(gui.Rectangle(x = panel_pos_x + 20.0, y = panel_pos_y + 52.0, width = 20.0, height = 20.0), show_values_text, ptr_of(show_values))
        gui.GuiCheckBox(gui.Rectangle(x = panel_pos_x + 20.0, y = panel_pos_y + 82.0, width = 20.0, height = 20.0), show_percentages_text, ptr_of(show_percentages))
        gui.GuiCheckBox(gui.Rectangle(x = panel_pos_x + 20.0, y = panel_pos_y + 112.0, width = 20.0, height = 20.0), make_donut_text, ptr_of(show_donut))

        if show_donut:
            gui.GuiDisable()

        gui.GuiSliderBar(gui.Rectangle(x = panel_pos_x + 80.0, y = panel_pos_y + 142.0, width = panel_rect.width - 100.0, height = 30.0), inner_radius_text, empty_text, ptr_of(donut_inner_radius), 5.0, radius - 10.0)
        gui.GuiEnable()
