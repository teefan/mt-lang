module examples.raylib.textures.textures_npatch_drawing
...
def main() -> i32:
    ...
    let npatch_texture = rl.LoadTexture(npatch_texture_path)
    defer rl.UnloadTexture(npatch_texture)
    ...
    while not rl.WindowShouldClose():
        ...
        rl.DrawTextureNPatch(npatch_texture, nine_patch_info_2, dst_rec_2, origin, 0.0, rl.WHITE)
        rl.DrawTextureNPatch(npatch_texture, nine_patch_info_1, dst_rec_1, origin, 0.0, rl.WHITE)
        rl.DrawTextureNPatch(npatch_texture, h3_patch_info, dst_rec_h, origin, 0.0, rl.WHITE)
        rl.DrawTextureNPatch(npatch_texture, v3_patch_info, dst_rec_v, origin, 0.0, rl.WHITE)

        rl.DrawRectangleLines(5, 88, 74, 266, rl.BLUE)
        rl.DrawTexture(npatch_texture, 10, 93, rl.WHITE)
        rl.DrawText(texture_label, 15, 360, 10, rl.DARKGRAY)
        rl.DrawText(help_text, 10, 20, 20, rl.DARKGRAY)
