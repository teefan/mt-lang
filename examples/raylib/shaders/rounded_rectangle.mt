...
function main() -> int:
    ...
    rl.set_shader_value(shader, rounded_rectangle.radius_loc, corner_radius, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
    rl.set_shader_value(shader, rounded_rectangle.shadow_radius_loc, shadow_radius, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_FLOAT)
    rl.set_shader_value(shader, rounded_rectangle.shadow_offset_loc, shadow_offset, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC2)
    rl.set_shader_value(shader, rounded_rectangle.shadow_scale_loc, shadow_scale, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_FLOAT)
    rl.set_shader_value(shader, rounded_rectangle.border_thickness_loc, border_thickness, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_FLOAT)
    ...
    while not rl.window_should_close():
        ...
        rl.set_shader_value(shader, rounded_rectangle.rectangle_loc, rec0, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.color_loc, rectangle_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.shadow_color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.border_color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        ...
        rl.set_shader_value(shader, rounded_rectangle.rectangle_loc, rec1, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.shadow_color_loc, shadow_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.border_color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.begin_shader_mode(shader)
        rl.draw_rectangle(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, rl.WHITE)
        rl.end_shader_mode()
        ...
        rl.set_shader_value(shader, rounded_rectangle.rectangle_loc, rec2, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.shadow_color_loc, transparent, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.border_color_loc, border_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.begin_shader_mode(shader)
        rl.draw_rectangle(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, rl.WHITE)
        rl.end_shader_mode()
        ...
        rl.set_shader_value(shader, rounded_rectangle.rectangle_loc, rec3, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.color_loc, rectangle_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.shadow_color_loc, shadow_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.set_shader_value(shader, rounded_rectangle.border_color_loc, border_color, int<-rl.ShaderUniformDataType.SHADER_UNIFORM_VEC4)
        rl.begin_shader_mode(shader)
        ...
        rl.draw_text("(c) Rounded rectangle SDF by Inigo Quilez. MIT License.", SCREEN_WIDTH - 300, SCREEN_HEIGHT - 20, 10, rl.BLACK)
        rl.end_drawing()
