...
def main() -> i32:
    ...
    while not rl.WindowShouldClose():
        ...
        rl.SetShaderValue(shader, view_eye_loc, ptr_of(camera_pos[0]), rl.ShaderUniformDataType.SHADER_UNIFORM_VEC3)
        rl.SetShaderValue(shader, view_center_loc, ptr_of(camera_target[0]), rl.ShaderUniformDataType.SHADER_UNIFORM_VEC3)
