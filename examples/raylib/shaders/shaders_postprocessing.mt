...
def main() -> i32:
    ...
    shaders[fx_grayscale] = rl.LoadShader(null_cstr(), rl.TextFormat(grayscale_shader_path, glsl_version))
    shaders[fx_posterization] = rl.LoadShader(null_cstr(), rl.TextFormat(posterization_shader_path, glsl_version))
    shaders[fx_dream_vision] = rl.LoadShader(null_cstr(), rl.TextFormat(dream_vision_shader_path, glsl_version))
    shaders[fx_pixelizer] = rl.LoadShader(null_cstr(), rl.TextFormat(pixelizer_shader_path, glsl_version))
    shaders[fx_cross_hatching] = rl.LoadShader(null_cstr(), rl.TextFormat(cross_hatching_shader_path, glsl_version))
    shaders[fx_cross_stitching] = rl.LoadShader(null_cstr(), rl.TextFormat(cross_stitching_shader_path, glsl_version))
    shaders[fx_predator_view] = rl.LoadShader(null_cstr(), rl.TextFormat(predator_shader_path, glsl_version))
    shaders[fx_scanlines] = rl.LoadShader(null_cstr(), rl.TextFormat(scanlines_shader_path, glsl_version))
    shaders[fx_fisheye] = rl.LoadShader(null_cstr(), rl.TextFormat(fisheye_shader_path, glsl_version))
    shaders[fx_sobel] = rl.LoadShader(null_cstr(), rl.TextFormat(sobel_shader_path, glsl_version))
    shaders[fx_bloom] = rl.LoadShader(null_cstr(), rl.TextFormat(bloom_shader_path, glsl_version))
    shaders[fx_blur] = rl.LoadShader(null_cstr(), rl.TextFormat(blur_shader_path, glsl_version))
