...
def main(argc: int, argv: ptr[ptr[char]]) -> int:
    ...
    let first_window = glfw.glfwCreateWindow(400, 400, first_window_title, null, null)
    ...
    let second_window = glfw.glfwCreateWindow(400, 400, second_window_title, null, first_window)
