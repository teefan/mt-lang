...
def main() -> i32:
    ...
    let center_y_delta = cast[f32](rl.get_screen_height() / 2 + 100)
    ...
    while not rl.window_should_close():
        if state == 0:
            frames_counter += 1
            rec.y = ease.elastic_out(cast[f32](frames_counter), -100.0, center_y_delta, 120.0)
            ...
            frames_counter += 1
            rec.height = ease.bounce_out(cast[f32](frames_counter), 100.0, -90.0, 120.0)
            rec.width = ease.bounce_out(cast[f32](frames_counter), 100.0, cast[f32](rl.get_screen_width()), 120.0)
            ...
            frames_counter += 1
            rotation = ease.quad_out(cast[f32](frames_counter), 0.0, 270.0, 240.0)
            ...
            frames_counter += 1
            rec.height = ease.circ_out(cast[f32](frames_counter), 10.0, cast[f32](rl.get_screen_width()), 120.0)
            ...
            frames_counter += 1
            alpha = ease.sine_out(cast[f32](frames_counter), 1.0, -1.0, 160.0)
