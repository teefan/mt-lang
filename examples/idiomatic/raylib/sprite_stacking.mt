...
def main() -> int:
    ...
    while not rl.window_should_close():
        ...
        rl.draw_text(rl.text_format_float("current spacing: %.01f", stack_spacing), 10, 60, 20, rl.DARKGRAY)
        rl.draw_text(rl.text_format_float("current speed: %.02f", rotation_speed), 10, 80, 20, rl.DARKGRAY)
