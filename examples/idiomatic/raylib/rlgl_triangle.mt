...
function emit_triangle_edge(start: rl.Vector2, finish: rl.Vector2, start_color: rl.Color, finish_color: rl.Color) -> void:
...
function emit_triangle_point(point: rl.Vector2, color: rl.Color) -> void:
