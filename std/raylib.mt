...
pub foreign def get_file_mod_time(file_name: cstr) -> isize = c.GetFileModTime
...
pub foreign def get_pixel_color[T](src_ptr: ptr[T] as ptr[void], format: i32) -> Color = c.GetPixelColor
...
pub foreign def load_font_data(file_data: const_ptr[u8], data_size: i32, font_size: i32, codepoints: ptr[i32]?, codepoint_count: i32, kind: FontType, out glyph_count: i32) -> ptr[GlyphInfo] = c.LoadFontData
