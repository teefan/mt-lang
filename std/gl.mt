...
public foreign function blend_equation_separatei(buf: uint, mode_rgb: uint, mode_alpha: uint) -> void = c.glBlendEquationSeparatei
public foreign function blend_equationi(buf: uint, mode: uint) -> void = c.glBlendEquationi
...
public foreign function blend_func_separatei(buf: uint, src_rgb: uint, dst_rgb: uint, src_alpha: uint, dst_alpha: uint) -> void = c.glBlendFuncSeparatei
public foreign function blend_funci(buf: uint, src: uint, dst: uint) -> void = c.glBlendFunci
...
public foreign function clear_depthf(d: float) -> void = c.glClearDepthf
...
public foreign function color_maski(index: uint, r: ubyte, g: ubyte, b: ubyte, a: ubyte) -> void = c.glColorMaski
...
public foreign function create_vertex_arrays(n: int, arrays: ptr[GLuint]) -> void = c.glCreateVertexArrays
...
public foreign function delete_vertex_arrays(n: int, arrays: const_ptr[GLuint]) -> void = c.glDeleteVertexArrays
...
public foreign function depth_range_arrayv(first: uint, count: int, v: const_ptr[GLdouble]) -> void = c.glDepthRangeArrayv
public foreign function depth_range_indexed(index: uint, n: double, f: double) -> void = c.glDepthRangeIndexed
public foreign function depth_rangef(n: float, f: float) -> void = c.glDepthRangef
...
public foreign function disablei(target: uint, index: uint) -> void = c.glDisablei
...
public foreign function draw_arrays(mode: uint, first: int, count: int) -> void = c.glDrawArrays
public foreign function draw_arrays_indirect(mode: uint, indirect: const_ptr[void]) -> void = c.glDrawArraysIndirect
public foreign function draw_arrays_instanced(mode: uint, first: int, count: int, instancecount: int) -> void = c.glDrawArraysInstanced
public foreign function draw_arrays_instanced_base_instance(mode: uint, first: int, count: int, instancecount: int, baseinstance: uint) -> void = c.glDrawArraysInstancedBaseInstance
...
public foreign function enablei(target: uint, index: uint) -> void = c.glEnablei
...
public foreign function gen_vertex_arrays(n: int, arrays: ptr[GLuint]) -> void = c.glGenVertexArrays
...
public foreign function get_active_subroutine_uniformiv(program: uint, shadertype: uint, index: uint, pname: uint, values: ptr[GLint]) -> void = c.glGetActiveSubroutineUniformiv
...
public foreign function get_query_indexediv(target: uint, index: uint, pname: uint, params: ptr[GLint]) -> void = c.glGetQueryIndexediv
...
public foreign function get_stringi(name: uint, index: uint) -> const_ptr[GLubyte] = c.glGetStringi
...
public foreign function get_uniform_subroutineuiv(shadertype: uint, location: int, params: ptr[GLuint]) -> void = c.glGetUniformSubroutineuiv
public foreign function get_uniformdv(program: uint, location: int, params: ptr[GLdouble]) -> void = c.glGetUniformdv
public foreign function get_uniformfv(program: uint, location: int, params: ptr[GLfloat]) -> void = c.glGetUniformfv
public foreign function get_uniformiv(program: uint, location: int, params: ptr[GLint]) -> void = c.glGetUniformiv
public foreign function get_uniformuiv(program: uint, location: int, params: ptr[GLuint]) -> void = c.glGetUniformuiv
...
public foreign function get_vertex_array_indexediv(vaobj: uint, index: uint, pname: uint, param: ptr[GLint]) -> void = c.glGetVertexArrayIndexediv
public foreign function get_vertex_arrayiv(vaobj: uint, pname: uint, param: ptr[GLint]) -> void = c.glGetVertexArrayiv
...
public foreign function getn_compressed_tex_image(target: uint, lod: int, buf_size: int, pixels: ptr[void]) -> void = c.glGetnCompressedTexImage
public foreign function getn_tex_image(target: uint, level: int, format: uint, type_: uint, buf_size: int, pixels: ptr[void]) -> void = c.glGetnTexImage
public foreign function getn_uniformdv(program: uint, location: int, buf_size: int, params: ptr[GLdouble]) -> void = c.glGetnUniformdv
public foreign function getn_uniformfv(program: uint, location: int, buf_size: int, params: ptr[GLfloat]) -> void = c.glGetnUniformfv
public foreign function getn_uniformiv(program: uint, location: int, buf_size: int, params: ptr[GLint]) -> void = c.glGetnUniformiv
public foreign function getn_uniformuiv(program: uint, location: int, buf_size: int, params: ptr[GLuint]) -> void = c.glGetnUniformuiv
...
public foreign function is_enabledi(target: uint, index: uint) -> GLboolean = c.glIsEnabledi
...
public foreign function multi_draw_arrays(mode: uint, first: const_ptr[GLint], count: const_ptr[GLsizei], drawcount: int) -> void = c.glMultiDrawArrays
public foreign function multi_draw_arrays_indirect(mode: uint, indirect: const_ptr[void], drawcount: int, stride: int) -> void = c.glMultiDrawArraysIndirect
public foreign function multi_draw_arrays_indirect_count(mode: uint, indirect: const_ptr[void], drawcount: ptr_int, maxdrawcount: int, stride: int) -> void = c.glMultiDrawArraysIndirectCount
...
public foreign function pixel_storef(pname: uint, param: float) -> void = c.glPixelStoref
public foreign function pixel_storei(pname: uint, param: int) -> void = c.glPixelStorei
...
public foreign function sample_maski(mask_number: uint, mask: uint) -> void = c.glSampleMaski
...
public foreign function scissor_arrayv(first: uint, count: int, v: const_ptr[GLint]) -> void = c.glScissorArrayv
public foreign function scissor_indexed(index: uint, left: int, bottom: int, width: int, height: int) -> void = c.glScissorIndexed
public foreign function scissor_indexedv(index: uint, v: const_ptr[GLint]) -> void = c.glScissorIndexedv
...
public foreign function uniform_subroutinesuiv(shadertype: uint, count: int, indices: const_ptr[GLuint]) -> void = c.glUniformSubroutinesuiv
...
public foreign function viewport_arrayv(first: uint, count: int, v: const_ptr[GLfloat]) -> void = c.glViewportArrayv
public foreign function viewport_indexedf(index: uint, x: float, y: float, w: float, h: float) -> void = c.glViewportIndexedf
public foreign function viewport_indexedfv(index: uint, v: const_ptr[GLfloat]) -> void = c.glViewportIndexedfv
