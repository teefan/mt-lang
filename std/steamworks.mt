...
public foreign function set_mini_dump_comment(pch_msg: cstr) -> void = c.SteamAPI_SetMiniDumpComment
...
public foreign function use_breakpad_crash_handler(pch_version: cstr, pch_date: cstr, pch_time: cstr, b_full_memory_dumps: bool, pv_context: ptr[void], pfn_pre_minidump_callback: fn(arg0: ptr[void]) -> void) -> void = c.SteamAPI_UseBreakpadCrashHandler
...
public foreign function internal_init(psz_internal_check_interface_versions: cstr, p_out_err_msg: ptr[ErrMsg]) -> EAPIInitResult = c.SteamInternal_SteamAPI_Init
...
public foreign function internal_create_interface(ver: cstr) -> ptr[void] = c.SteamInternal_CreateInterface
public foreign function internal_find_or_create_user_interface(h_steam_user: int, psz_version: cstr) -> ptr[void] = c.SteamInternal_FindOrCreateUserInterface
public foreign function internal_find_or_create_game_server_interface(h_steam_user: int, psz_version: cstr) -> ptr[void] = c.SteamInternal_FindOrCreateGameServerInterface
...
public foreign function internal_game_server_init_v_2(un_ip: uint, us_game_port: ushort, us_query_port: ushort, e_server_mode: EServerMode, pch_version_string: cstr, psz_internal_check_interface_versions: cstr, p_out_err_msg: ptr[ErrMsg]) -> EAPIInitResult = c.SteamInternal_GameServer_Init_V2
public foreign function user_v_023() -> ptr[User] = c.SteamAPI_SteamUser_v023
public foreign function friends_v_018() -> ptr[Friends] = c.SteamAPI_SteamFriends_v018
public foreign function utils_v_010() -> ptr[Utils] = c.SteamAPI_SteamUtils_v010
public foreign function game_server_utils_v_010() -> ptr[Utils] = c.SteamAPI_SteamGameServerUtils_v010
public foreign function matchmaking_v_009() -> ptr[Matchmaking] = c.SteamAPI_SteamMatchmaking_v009
public foreign function matchmaking_servers_v_002() -> ptr[MatchmakingServers] = c.SteamAPI_SteamMatchmakingServers_v002
public foreign function parties_v_002() -> ptr[Parties] = c.SteamAPI_SteamParties_v002
public foreign function remote_storage_v_016() -> ptr[RemoteStorage] = c.SteamAPI_SteamRemoteStorage_v016
public foreign function user_stats_v_013() -> ptr[UserStats] = c.SteamAPI_SteamUserStats_v013
public foreign function apps_v_009() -> ptr[Apps] = c.SteamAPI_SteamApps_v009
public foreign function networking_v_006() -> ptr[Networking] = c.SteamAPI_SteamNetworking_v006
public foreign function game_server_networking_v_006() -> ptr[Networking] = c.SteamAPI_SteamGameServerNetworking_v006
public foreign function screenshots_v_003() -> ptr[Screenshots] = c.SteamAPI_SteamScreenshots_v003
public foreign function music_v_001() -> ptr[Music] = c.SteamAPI_SteamMusic_v001
public foreign function http_v_003() -> ptr[HTTP] = c.SteamAPI_SteamHTTP_v003
public foreign function game_server_http_v_003() -> ptr[HTTP] = c.SteamAPI_SteamGameServerHTTP_v003
public foreign function input_v_006() -> ptr[Input] = c.SteamAPI_SteamInput_v006
public foreign function controller_v_008() -> ptr[Controller] = c.SteamAPI_SteamController_v008
public foreign function ugc_v_021() -> ptr[UGC] = c.SteamAPI_SteamUGC_v021
public foreign function game_server_ugc_v_021() -> ptr[UGC] = c.SteamAPI_SteamGameServerUGC_v021
public foreign function html_surface_v_005() -> ptr[HTMLSurface] = c.SteamAPI_SteamHTMLSurface_v005
public foreign function inventory_v_003() -> ptr[Inventory] = c.SteamAPI_SteamInventory_v003
public foreign function game_server_inventory_v_003() -> ptr[Inventory] = c.SteamAPI_SteamGameServerInventory_v003
public foreign function timeline_v_004() -> ptr[Timeline] = c.SteamAPI_SteamTimeline_v004
public foreign function video_v_007() -> ptr[Video] = c.SteamAPI_SteamVideo_v007
public foreign function parental_settings_v_001() -> ptr[ParentalSettings] = c.SteamAPI_SteamParentalSettings_v001
public foreign function remote_play_v_004() -> ptr[RemotePlay] = c.SteamAPI_SteamRemotePlay_v004
...
public foreign function game_server_networking_messages_v_002() -> ptr[NetworkingMessages] = c.SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002
public foreign function networking_sockets_v_012() -> ptr[NetworkingSockets] = c.SteamAPI_SteamNetworkingSockets_SteamAPI_v012
public foreign function game_server_networking_sockets_v_012() -> ptr[NetworkingSockets] = c.SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012
public foreign function networking_utils_v_004() -> ptr[NetworkingUtils] = c.SteamAPI_SteamNetworkingUtils_SteamAPI_v004
public foreign function game_server_v_015() -> ptr[GameServer] = c.SteamAPI_SteamGameServer_v015
public foreign function game_server_stats_v_001() -> ptr[GameServerStats] = c.SteamAPI_SteamGameServerStats_v001
...
public foreign function client_get_i_steam_user(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[User] = c.SteamAPI_ISteamClient_GetISteamUser
public foreign function client_get_i_steam_game_server(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[GameServer] = c.SteamAPI_ISteamClient_GetISteamGameServer
...
public foreign function client_get_i_steam_friends(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Friends] = c.SteamAPI_ISteamClient_GetISteamFriends
public foreign function client_get_i_steam_utils(self: ptr[Client], h_steam_pipe: int, pch_version: cstr) -> ptr[Utils] = c.SteamAPI_ISteamClient_GetISteamUtils
public foreign function client_get_i_steam_matchmaking(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Matchmaking] = c.SteamAPI_ISteamClient_GetISteamMatchmaking
public foreign function client_get_i_steam_matchmaking_servers(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[MatchmakingServers] = c.SteamAPI_ISteamClient_GetISteamMatchmakingServers
public foreign function client_get_i_steam_generic_interface(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[void] = c.SteamAPI_ISteamClient_GetISteamGenericInterface
public foreign function client_get_i_steam_user_stats(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[UserStats] = c.SteamAPI_ISteamClient_GetISteamUserStats
public foreign function client_get_i_steam_game_server_stats(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[GameServerStats] = c.SteamAPI_ISteamClient_GetISteamGameServerStats
public foreign function client_get_i_steam_apps(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Apps] = c.SteamAPI_ISteamClient_GetISteamApps
public foreign function client_get_i_steam_networking(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Networking] = c.SteamAPI_ISteamClient_GetISteamNetworking
public foreign function client_get_i_steam_remote_storage(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[RemoteStorage] = c.SteamAPI_ISteamClient_GetISteamRemoteStorage
public foreign function client_get_i_steam_screenshots(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Screenshots] = c.SteamAPI_ISteamClient_GetISteamScreenshots
...
public foreign function client_get_i_steam_http(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[HTTP] = c.SteamAPI_ISteamClient_GetISteamHTTP
public foreign function client_get_i_steam_controller(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Controller] = c.SteamAPI_ISteamClient_GetISteamController
public foreign function client_get_i_steam_ugc(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[UGC] = c.SteamAPI_ISteamClient_GetISteamUGC
public foreign function client_get_i_steam_music(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Music] = c.SteamAPI_ISteamClient_GetISteamMusic
public foreign function client_get_i_steam_html_surface(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[HTMLSurface] = c.SteamAPI_ISteamClient_GetISteamHTMLSurface
public foreign function client_get_i_steam_inventory(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Inventory] = c.SteamAPI_ISteamClient_GetISteamInventory
public foreign function client_get_i_steam_video(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Video] = c.SteamAPI_ISteamClient_GetISteamVideo
public foreign function client_get_i_steam_parental_settings(self: ptr[Client], h_steamuser: int, h_steam_pipe: int, pch_version: cstr) -> ptr[ParentalSettings] = c.SteamAPI_ISteamClient_GetISteamParentalSettings
public foreign function client_get_i_steam_input(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Input] = c.SteamAPI_ISteamClient_GetISteamInput
public foreign function client_get_i_steam_parties(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[Parties] = c.SteamAPI_ISteamClient_GetISteamParties
public foreign function client_get_i_steam_remote_play(self: ptr[Client], h_steam_user: int, h_steam_pipe: int, pch_version: cstr) -> ptr[RemotePlay] = c.SteamAPI_ISteamClient_GetISteamRemotePlay
...
public foreign function user_track_app_usage_event(self: ptr[User], game_id: ulong, e_app_usage_event: int, pch_extra_info: cstr) -> void = c.SteamAPI_ISteamUser_TrackAppUsageEvent
...
public foreign function user_get_auth_ticket_for_web_api(self: ptr[User], pch_identity: cstr) -> HAuthTicket = c.SteamAPI_ISteamUser_GetAuthTicketForWebApi
...
public foreign function user_request_store_auth_url(self: ptr[User], pch_redirect_url: cstr) -> APICall_t = c.SteamAPI_ISteamUser_RequestStoreAuthURL
...
public foreign function friends_activate_game_overlay(self: ptr[Friends], pch_dialog: cstr) -> void = c.SteamAPI_ISteamFriends_ActivateGameOverlay
public foreign function friends_activate_game_overlay_to_user(self: ptr[Friends], pch_dialog: cstr, steam_id: ulong) -> void = c.SteamAPI_ISteamFriends_ActivateGameOverlayToUser
public foreign function friends_activate_game_overlay_to_web_page(self: ptr[Friends], pch_url: cstr, e_mode: EActivateGameOverlayToWebPageMode) -> void = c.SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage
...
public foreign function friends_set_rich_presence(self: ptr[Friends], pch_key: cstr, pch_value: cstr) -> bool = c.SteamAPI_ISteamFriends_SetRichPresence
public foreign function friends_clear_rich_presence(self: ptr[Friends]) -> void = c.SteamAPI_ISteamFriends_ClearRichPresence
public foreign function friends_get_friend_rich_presence(self: ptr[Friends], steam_id_friend: ulong, pch_key: cstr) -> cstr = c.SteamAPI_ISteamFriends_GetFriendRichPresence
...
public foreign function friends_invite_user_to_game(self: ptr[Friends], steam_id_friend: ulong, pch_connect_string: cstr) -> bool = c.SteamAPI_ISteamFriends_InviteUserToGame
...
public foreign function friends_send_clan_chat_message(self: ptr[Friends], steam_id_clan_chat: ulong, pch_text: cstr) -> bool = c.SteamAPI_ISteamFriends_SendClanChatMessage
...
public foreign function friends_reply_to_friend_message(self: ptr[Friends], steam_id_friend: ulong, pch_msg_to_send: cstr) -> bool = c.SteamAPI_ISteamFriends_ReplyToFriendMessage
...
public foreign function friends_register_protocol_in_overlay_browser(self: ptr[Friends], pch_protocol: cstr) -> bool = c.SteamAPI_ISteamFriends_RegisterProtocolInOverlayBrowser
public foreign function friends_activate_game_overlay_invite_dialog_connect_string(self: ptr[Friends], pch_connect_string: cstr) -> void = c.SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialogConnectString
...
public foreign function utils_check_file_signature(self: ptr[Utils], sz_file_name: cstr) -> APICall_t = c.SteamAPI_ISteamUtils_CheckFileSignature
public foreign function utils_show_gamepad_text_input(self: ptr[Utils], e_input_mode: EGamepadTextInputMode, e_line_input_mode: EGamepadTextInputLineMode, pch_description: cstr, un_char_max: uint, pch_existing_text: cstr) -> bool = c.SteamAPI_ISteamUtils_ShowGamepadTextInput
...
public foreign function utils_filter_text(self: ptr[Utils], e_context: ETextFilteringContext, source_steam_id: ulong, pch_input_message: cstr, pch_out_filtered_text: ptr[char], n_byte_size_out_filtered_text: uint) -> int = c.SteamAPI_ISteamUtils_FilterText
public foreign function utils_get_i_pv_6connectivity_state(self: ptr[Utils], e_protocol: EIPv6ConnectivityProtocol) -> EIPv6ConnectivityState = c.SteamAPI_ISteamUtils_GetIPv6ConnectivityState
...
public foreign function matchmaking_get_favorite_game(self: ptr[Matchmaking], i_game: int, pn_app_id: ptr[AppId_t], pn_ip: ptr[uint32], pn_conn_port: ptr[uint16], pn_query_port: ptr[uint16], pun_flags: ptr[uint32], p_r_time_32last_played_on_server: ptr[uint32]) -> bool = c.SteamAPI_ISteamMatchmaking_GetFavoriteGame
public foreign function matchmaking_add_favorite_game(self: ptr[Matchmaking], n_app_id: uint, n_ip: uint, n_conn_port: ushort, n_query_port: ushort, un_flags: uint, r_time_32last_played_on_server: uint) -> int = c.SteamAPI_ISteamMatchmaking_AddFavoriteGame
...
public foreign function matchmaking_add_request_lobby_list_string_filter(self: ptr[Matchmaking], pch_key_to_match: cstr, pch_value_to_match: cstr, e_comparison_type: ELobbyComparison) -> void = c.SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter
public foreign function matchmaking_add_request_lobby_list_numerical_filter(self: ptr[Matchmaking], pch_key_to_match: cstr, n_value_to_match: int, e_comparison_type: ELobbyComparison) -> void = c.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter
public foreign function matchmaking_add_request_lobby_list_near_value_filter(self: ptr[Matchmaking], pch_key_to_match: cstr, n_value_to_be_close_to: int) -> void = c.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter
...
public foreign function matchmaking_get_lobby_data(self: ptr[Matchmaking], steam_id_lobby: ulong, pch_key: cstr) -> cstr = c.SteamAPI_ISteamMatchmaking_GetLobbyData
public foreign function matchmaking_set_lobby_data(self: ptr[Matchmaking], steam_id_lobby: ulong, pch_key: cstr, pch_value: cstr) -> bool = c.SteamAPI_ISteamMatchmaking_SetLobbyData
...
public foreign function matchmaking_delete_lobby_data(self: ptr[Matchmaking], steam_id_lobby: ulong, pch_key: cstr) -> bool = c.SteamAPI_ISteamMatchmaking_DeleteLobbyData
public foreign function matchmaking_get_lobby_member_data(self: ptr[Matchmaking], steam_id_lobby: ulong, steam_id_user: ulong, pch_key: cstr) -> cstr = c.SteamAPI_ISteamMatchmaking_GetLobbyMemberData
public foreign function matchmaking_set_lobby_member_data(self: ptr[Matchmaking], steam_id_lobby: ulong, pch_key: cstr, pch_value: cstr) -> void = c.SteamAPI_ISteamMatchmaking_SetLobbyMemberData
...
public foreign function matchmaking_players_response_add_player_to_list(self: ptr[MatchmakingPlayersResponse], pch_name: cstr, n_score: int, fl_time_played: float) -> void = c.SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList
...
public foreign function matchmaking_rules_response_rules_responded(self: ptr[MatchmakingRulesResponse], pch_rule: cstr, pch_value: cstr) -> void = c.SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded
...
public foreign function parties_create_beacon(self: ptr[Parties], un_open_slots: uint, p_beacon_location: ptr[PartyBeaconLocation_t], pch_connect_string: cstr, pch_metadata: cstr) -> APICall_t = c.SteamAPI_ISteamParties_CreateBeacon
...
public foreign function remote_storage_file_write(self: ptr[RemoteStorage], pch_file: cstr, pv_data: const_ptr[void], cub_data: int) -> bool = c.SteamAPI_ISteamRemoteStorage_FileWrite
public foreign function remote_storage_file_read(self: ptr[RemoteStorage], pch_file: cstr, pv_data: ptr[void], cub_data_to_read: int) -> int32 = c.SteamAPI_ISteamRemoteStorage_FileRead
public foreign function remote_storage_file_write_async(self: ptr[RemoteStorage], pch_file: cstr, pv_data: const_ptr[void], cub_data: uint) -> APICall_t = c.SteamAPI_ISteamRemoteStorage_FileWriteAsync
public foreign function remote_storage_file_read_async(self: ptr[RemoteStorage], pch_file: cstr, n_offset: uint, cub_to_read: uint) -> APICall_t = c.SteamAPI_ISteamRemoteStorage_FileReadAsync
...
public foreign function remote_storage_file_forget(self: ptr[RemoteStorage], pch_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_FileForget
public foreign function remote_storage_file_delete(self: ptr[RemoteStorage], pch_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_FileDelete
public foreign function remote_storage_file_share(self: ptr[RemoteStorage], pch_file: cstr) -> APICall_t = c.SteamAPI_ISteamRemoteStorage_FileShare
public foreign function remote_storage_set_sync_platforms(self: ptr[RemoteStorage], pch_file: cstr, e_remote_storage_platform: ERemoteStoragePlatform) -> bool = c.SteamAPI_ISteamRemoteStorage_SetSyncPlatforms
public foreign function remote_storage_file_write_stream_open(self: ptr[RemoteStorage], pch_file: cstr) -> UGCFileWriteStreamHandle_t = c.SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen
...
public foreign function remote_storage_file_exists(self: ptr[RemoteStorage], pch_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_FileExists
public foreign function remote_storage_file_persisted(self: ptr[RemoteStorage], pch_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_FilePersisted
public foreign function remote_storage_get_file_size(self: ptr[RemoteStorage], pch_file: cstr) -> int32 = c.SteamAPI_ISteamRemoteStorage_GetFileSize
public foreign function remote_storage_get_file_timestamp(self: ptr[RemoteStorage], pch_file: cstr) -> int64 = c.SteamAPI_ISteamRemoteStorage_GetFileTimestamp
public foreign function remote_storage_get_sync_platforms(self: ptr[RemoteStorage], pch_file: cstr) -> ERemoteStoragePlatform = c.SteamAPI_ISteamRemoteStorage_GetSyncPlatforms
...
public foreign function remote_storage_publish_workshop_file(self: ptr[RemoteStorage], pch_file: cstr, pch_preview_file: cstr, n_consumer_app_id: uint, pch_title: cstr, pch_description: cstr, e_visibility: ERemoteStoragePublishedFileVisibility, p_tags: ptr[ParamStringArray_t], e_workshop_file_type: EWorkshopFileType) -> APICall_t = c.SteamAPI_ISteamRemoteStorage_PublishWorkshopFile
...
public foreign function remote_storage_update_published_file_file(self: ptr[RemoteStorage], update_handle: ulong, pch_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile
public foreign function remote_storage_update_published_file_preview_file(self: ptr[RemoteStorage], update_handle: ulong, pch_preview_file: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile
public foreign function remote_storage_update_published_file_title(self: ptr[RemoteStorage], update_handle: ulong, pch_title: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle
public foreign function remote_storage_update_published_file_description(self: ptr[RemoteStorage], update_handle: ulong, pch_description: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription
...
public foreign function remote_storage_update_published_file_set_change_description(self: ptr[RemoteStorage], update_handle: ulong, pch_change_description: cstr) -> bool = c.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription
...
public foreign function remote_storage_ugc_download_to_location(self: ptr[RemoteStorage], h_content: ulong, pch_location: cstr, un_priority: uint) -> APICall_t = c.SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation
...
public foreign function user_stats_get_stat_int_32(self: ptr[UserStats], pch_name: cstr, p_data: ptr[int32]) -> bool = c.SteamAPI_ISteamUserStats_GetStatInt32
public foreign function user_stats_get_stat_float(self: ptr[UserStats], pch_name: cstr, p_data: ptr[float]) -> bool = c.SteamAPI_ISteamUserStats_GetStatFloat
public foreign function user_stats_set_stat_int_32(self: ptr[UserStats], pch_name: cstr, n_data: int) -> bool = c.SteamAPI_ISteamUserStats_SetStatInt32
public foreign function user_stats_set_stat_float(self: ptr[UserStats], pch_name: cstr, f_data: float) -> bool = c.SteamAPI_ISteamUserStats_SetStatFloat
public foreign function user_stats_update_avg_rate_stat(self: ptr[UserStats], pch_name: cstr, fl_count_this_session: float, d_session_length: double) -> bool = c.SteamAPI_ISteamUserStats_UpdateAvgRateStat
public foreign function user_stats_get_achievement(self: ptr[UserStats], pch_name: cstr, pb_achieved: ptr[bool]) -> bool = c.SteamAPI_ISteamUserStats_GetAchievement
public foreign function user_stats_set_achievement(self: ptr[UserStats], pch_name: cstr) -> bool = c.SteamAPI_ISteamUserStats_SetAchievement
public foreign function user_stats_clear_achievement(self: ptr[UserStats], pch_name: cstr) -> bool = c.SteamAPI_ISteamUserStats_ClearAchievement
public foreign function user_stats_get_achievement_and_unlock_time(self: ptr[UserStats], pch_name: cstr, pb_achieved: ptr[bool], pun_unlock_time: ptr[uint32]) -> bool = c.SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime
public foreign function user_stats_store_stats(self: ptr[UserStats]) -> bool = c.SteamAPI_ISteamUserStats_StoreStats
public foreign function user_stats_get_achievement_icon(self: ptr[UserStats], pch_name: cstr) -> int = c.SteamAPI_ISteamUserStats_GetAchievementIcon
public foreign function user_stats_get_achievement_display_attribute(self: ptr[UserStats], pch_name: cstr, pch_key: cstr) -> cstr = c.SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute
public foreign function user_stats_indicate_achievement_progress(self: ptr[UserStats], pch_name: cstr, n_cur_progress: uint, n_max_progress: uint) -> bool = c.SteamAPI_ISteamUserStats_IndicateAchievementProgress
...
public foreign function user_stats_get_user_stat_int_32(self: ptr[UserStats], steam_id_user: ulong, pch_name: cstr, p_data: ptr[int32]) -> bool = c.SteamAPI_ISteamUserStats_GetUserStatInt32
public foreign function user_stats_get_user_stat_float(self: ptr[UserStats], steam_id_user: ulong, pch_name: cstr, p_data: ptr[float]) -> bool = c.SteamAPI_ISteamUserStats_GetUserStatFloat
public foreign function user_stats_get_user_achievement(self: ptr[UserStats], steam_id_user: ulong, pch_name: cstr, pb_achieved: ptr[bool]) -> bool = c.SteamAPI_ISteamUserStats_GetUserAchievement
public foreign function user_stats_get_user_achievement_and_unlock_time(self: ptr[UserStats], steam_id_user: ulong, pch_name: cstr, pb_achieved: ptr[bool], pun_unlock_time: ptr[uint32]) -> bool = c.SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime
...
public foreign function user_stats_find_or_create_leaderboard(self: ptr[UserStats], pch_leaderboard_name: cstr, e_leaderboard_sort_method: ELeaderboardSortMethod, e_leaderboard_display_type: ELeaderboardDisplayType) -> APICall_t = c.SteamAPI_ISteamUserStats_FindOrCreateLeaderboard
public foreign function user_stats_find_leaderboard(self: ptr[UserStats], pch_leaderboard_name: cstr) -> APICall_t = c.SteamAPI_ISteamUserStats_FindLeaderboard
...
public foreign function user_stats_get_achievement_achieved_percent(self: ptr[UserStats], pch_name: cstr, pfl_percent: ptr[float]) -> bool = c.SteamAPI_ISteamUserStats_GetAchievementAchievedPercent
...
public foreign function user_stats_get_global_stat_int_64(self: ptr[UserStats], pch_stat_name: cstr, p_data: ptr[int64]) -> bool = c.SteamAPI_ISteamUserStats_GetGlobalStatInt64
public foreign function user_stats_get_global_stat_double(self: ptr[UserStats], pch_stat_name: cstr, p_data: ptr[double]) -> bool = c.SteamAPI_ISteamUserStats_GetGlobalStatDouble
public foreign function user_stats_get_global_stat_history_int_64(self: ptr[UserStats], pch_stat_name: cstr, p_data: ptr[int64], cub_data: uint) -> int32 = c.SteamAPI_ISteamUserStats_GetGlobalStatHistoryInt64
public foreign function user_stats_get_global_stat_history_double(self: ptr[UserStats], pch_stat_name: cstr, p_data: ptr[double], cub_data: uint) -> int32 = c.SteamAPI_ISteamUserStats_GetGlobalStatHistoryDouble
public foreign function user_stats_get_achievement_progress_limits_int_32(self: ptr[UserStats], pch_name: cstr, pn_min_progress: ptr[int32], pn_max_progress: ptr[int32]) -> bool = c.SteamAPI_ISteamUserStats_GetAchievementProgressLimitsInt32
public foreign function user_stats_get_achievement_progress_limits_float(self: ptr[UserStats], pch_name: cstr, pf_min_progress: ptr[float], pf_max_progress: ptr[float]) -> bool = c.SteamAPI_ISteamUserStats_GetAchievementProgressLimitsFloat
...
public foreign function apps_get_launch_query_param(self: ptr[Apps], pch_key: cstr) -> cstr = c.SteamAPI_ISteamApps_GetLaunchQueryParam
...
public foreign function apps_get_file_details(self: ptr[Apps], psz_file_name: cstr) -> APICall_t = c.SteamAPI_ISteamApps_GetFileDetails
...
public foreign function apps_set_active_beta(self: ptr[Apps], pch_beta_name: cstr) -> bool = c.SteamAPI_ISteamApps_SetActiveBeta
public foreign function networking_send_p_2p_packet(self: ptr[Networking], steam_id_remote: ulong, pub_data: const_ptr[void], cub_data: uint, e_p_2p_send_type: EP2PSend, n_channel: int) -> bool = c.SteamAPI_ISteamNetworking_SendP2PPacket
public foreign function networking_is_p_2p_packet_available(self: ptr[Networking], pcub_msg_size: ptr[uint32], n_channel: int) -> bool = c.SteamAPI_ISteamNetworking_IsP2PPacketAvailable
public foreign function networking_read_p_2p_packet(self: ptr[Networking], pub_dest: ptr[void], cub_dest: uint, pcub_msg_size: ptr[uint32], psteam_id_remote: ptr[uint64_steamid], n_channel: int) -> bool = c.SteamAPI_ISteamNetworking_ReadP2PPacket
public foreign function networking_accept_p_2p_session_with_user(self: ptr[Networking], steam_id_remote: ulong) -> bool = c.SteamAPI_ISteamNetworking_AcceptP2PSessionWithUser
public foreign function networking_close_p_2p_session_with_user(self: ptr[Networking], steam_id_remote: ulong) -> bool = c.SteamAPI_ISteamNetworking_CloseP2PSessionWithUser
public foreign function networking_close_p_2p_channel_with_user(self: ptr[Networking], steam_id_remote: ulong, n_channel: int) -> bool = c.SteamAPI_ISteamNetworking_CloseP2PChannelWithUser
public foreign function networking_get_p_2p_session_state(self: ptr[Networking], steam_id_remote: ulong, p_connection_state: ptr[P2PSessionState_t]) -> bool = c.SteamAPI_ISteamNetworking_GetP2PSessionState
public foreign function networking_allow_p_2p_packet_relay(self: ptr[Networking], b_allow: bool) -> bool = c.SteamAPI_ISteamNetworking_AllowP2PPacketRelay
public foreign function networking_create_listen_socket(self: ptr[Networking], n_virtual_p_2p_port: int, n_ip: IPAddress_t, n_port: ushort, b_allow_use_of_packet_relay: bool) -> SNetListenSocket_t = c.SteamAPI_ISteamNetworking_CreateListenSocket
public foreign function networking_create_p_2p_connection_socket(self: ptr[Networking], steam_id_target: ulong, n_virtual_port: int, n_timeout_sec: int, b_allow_use_of_packet_relay: bool) -> SNetSocket_t = c.SteamAPI_ISteamNetworking_CreateP2PConnectionSocket
...
public foreign function screenshots_add_screenshot_to_library(self: ptr[Screenshots], pch_filename: cstr, pch_thumbnail_filename: cstr, n_width: int, n_height: int) -> ScreenshotHandle = c.SteamAPI_ISteamScreenshots_AddScreenshotToLibrary
...
public foreign function screenshots_set_location(self: ptr[Screenshots], h_screenshot: uint, pch_location: cstr) -> bool = c.SteamAPI_ISteamScreenshots_SetLocation
...
public foreign function screenshots_add_vr_screenshot_to_library(self: ptr[Screenshots], e_type: EVRScreenshotType, pch_filename: cstr, pch_vr_filename: cstr) -> ScreenshotHandle = c.SteamAPI_ISteamScreenshots_AddVRScreenshotToLibrary
...
public foreign function http_create_http_request(self: ptr[HTTP], e_http_request_method: EHTTPMethod, pch_absolute_url: cstr) -> HTTPRequestHandle = c.SteamAPI_ISteamHTTP_CreateHTTPRequest
...
public foreign function http_set_http_request_header_value(self: ptr[HTTP], h_request: uint, pch_header_name: cstr, pch_header_value: cstr) -> bool = c.SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue
public foreign function http_set_http_request_get_or_post_parameter(self: ptr[HTTP], h_request: uint, pch_param_name: cstr, pch_param_value: cstr) -> bool = c.SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter
...
public foreign function http_get_http_response_header_size(self: ptr[HTTP], h_request: uint, pch_header_name: cstr, un_response_header_size: ptr[uint32]) -> bool = c.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize
public foreign function http_get_http_response_header_value(self: ptr[HTTP], h_request: uint, pch_header_name: cstr, p_header_value_buffer: ptr[uint8], un_buffer_size: uint) -> bool = c.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue
...
public foreign function http_set_http_request_raw_post_body(self: ptr[HTTP], h_request: uint, pch_content_type: cstr, pub_body: ptr[uint8], un_body_len: uint) -> bool = c.SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody
...
public foreign function http_set_cookie(self: ptr[HTTP], h_cookie_container: uint, pch_host: cstr, pch_url: cstr, pch_cookie: cstr) -> bool = c.SteamAPI_ISteamHTTP_SetCookie
...
public foreign function http_set_http_request_user_agent_info(self: ptr[HTTP], h_request: uint, pch_user_agent_info: cstr) -> bool = c.SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo
...
public foreign function input_set_input_action_manifest_file_path(self: ptr[Input], pch_input_action_manifest_absolute_path: cstr) -> bool = c.SteamAPI_ISteamInput_SetInputActionManifestFilePath
...
public foreign function input_get_action_set_handle(self: ptr[Input], psz_action_set_name: cstr) -> InputActionSetHandle_t = c.SteamAPI_ISteamInput_GetActionSetHandle
...
public foreign function input_get_digital_action_handle(self: ptr[Input], psz_action_name: cstr) -> InputDigitalActionHandle_t = c.SteamAPI_ISteamInput_GetDigitalActionHandle
...
public foreign function input_get_analog_action_handle(self: ptr[Input], psz_action_name: cstr) -> InputAnalogActionHandle_t = c.SteamAPI_ISteamInput_GetAnalogActionHandle
...
public foreign function controller_get_action_set_handle(self: ptr[Controller], psz_action_set_name: cstr) -> ControllerActionSetHandle_t = c.SteamAPI_ISteamController_GetActionSetHandle
...
public foreign function controller_get_digital_action_handle(self: ptr[Controller], psz_action_name: cstr) -> ControllerDigitalActionHandle_t = c.SteamAPI_ISteamController_GetDigitalActionHandle
...
public foreign function controller_get_analog_action_handle(self: ptr[Controller], psz_action_name: cstr) -> ControllerAnalogActionHandle_t = c.SteamAPI_ISteamController_GetAnalogActionHandle
...
public foreign function ugc_create_query_all_ugc_request_cursor(self: ptr[UGC], e_query_type: EUGCQuery, e_matchinge_matching_ugc_type_file_type: EUGCMatchingUGCType, n_creator_app_id: uint, n_consumer_app_id: uint, pch_cursor: cstr) -> UGCQueryHandle_t = c.SteamAPI_ISteamUGC_CreateQueryAllUGCRequestCursor
...
public foreign function ugc_get_query_first_ugc_key_value_tag(self: ptr[UGC], handle: ulong, index: uint, pch_key: cstr, pch_value: ptr[char], cch_value_size: uint) -> bool = c.SteamAPI_ISteamUGC_GetQueryFirstUGCKeyValueTag
...
public foreign function ugc_add_required_tag(self: ptr[UGC], handle: ulong, p_tag_name: cstr) -> bool = c.SteamAPI_ISteamUGC_AddRequiredTag
...
public foreign function ugc_add_excluded_tag(self: ptr[UGC], handle: ulong, p_tag_name: cstr) -> bool = c.SteamAPI_ISteamUGC_AddExcludedTag
...
public foreign function ugc_set_language(self: ptr[UGC], handle: ulong, pch_language: cstr) -> bool = c.SteamAPI_ISteamUGC_SetLanguage
...
public foreign function ugc_set_cloud_file_name_filter(self: ptr[UGC], handle: ulong, p_match_cloud_file_name: cstr) -> bool = c.SteamAPI_ISteamUGC_SetCloudFileNameFilter
...
public foreign function ugc_set_search_text(self: ptr[UGC], handle: ulong, p_search_text: cstr) -> bool = c.SteamAPI_ISteamUGC_SetSearchText
...
public foreign function ugc_add_required_key_value_tag(self: ptr[UGC], handle: ulong, p_key: cstr, p_value: cstr) -> bool = c.SteamAPI_ISteamUGC_AddRequiredKeyValueTag
...
public foreign function ugc_set_item_title(self: ptr[UGC], handle: ulong, pch_title: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemTitle
public foreign function ugc_set_item_description(self: ptr[UGC], handle: ulong, pch_description: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemDescription
public foreign function ugc_set_item_update_language(self: ptr[UGC], handle: ulong, pch_language: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemUpdateLanguage
public foreign function ugc_set_item_metadata(self: ptr[UGC], handle: ulong, pch_meta_data: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemMetadata
...
public foreign function ugc_set_item_content(self: ptr[UGC], handle: ulong, psz_content_folder: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemContent
public foreign function ugc_set_item_preview(self: ptr[UGC], handle: ulong, psz_preview_file: cstr) -> bool = c.SteamAPI_ISteamUGC_SetItemPreview
...
public foreign function ugc_remove_item_key_value_tags(self: ptr[UGC], handle: ulong, pch_key: cstr) -> bool = c.SteamAPI_ISteamUGC_RemoveItemKeyValueTags
public foreign function ugc_add_item_key_value_tag(self: ptr[UGC], handle: ulong, pch_key: cstr, pch_value: cstr) -> bool = c.SteamAPI_ISteamUGC_AddItemKeyValueTag
public foreign function ugc_add_item_preview_file(self: ptr[UGC], handle: ulong, psz_preview_file: cstr, type_: EItemPreviewType) -> bool = c.SteamAPI_ISteamUGC_AddItemPreviewFile
public foreign function ugc_add_item_preview_video(self: ptr[UGC], handle: ulong, psz_video_id: cstr) -> bool = c.SteamAPI_ISteamUGC_AddItemPreviewVideo
public foreign function ugc_update_item_preview_file(self: ptr[UGC], handle: ulong, index: uint, psz_preview_file: cstr) -> bool = c.SteamAPI_ISteamUGC_UpdateItemPreviewFile
public foreign function ugc_update_item_preview_video(self: ptr[UGC], handle: ulong, index: uint, psz_video_id: cstr) -> bool = c.SteamAPI_ISteamUGC_UpdateItemPreviewVideo
...
public foreign function ugc_set_required_game_versions(self: ptr[UGC], handle: ulong, psz_game_branch_min: cstr, psz_game_branch_max: cstr) -> bool = c.SteamAPI_ISteamUGC_SetRequiredGameVersions
public foreign function ugc_submit_item_update(self: ptr[UGC], handle: ulong, pch_change_note: cstr) -> APICall_t = c.SteamAPI_ISteamUGC_SubmitItemUpdate
...
public foreign function ugc_b_init_workshop_for_game_server(self: ptr[UGC], un_workshop_depot_id: uint, psz_folder: cstr) -> bool = c.SteamAPI_ISteamUGC_BInitWorkshopForGameServer
...
public foreign function html_surface_create_browser(self: ptr[HTMLSurface], pch_user_agent: cstr, pch_user_css: cstr) -> APICall_t = c.SteamAPI_ISteamHTMLSurface_CreateBrowser
...
public foreign function html_surface_load_url(self: ptr[HTMLSurface], un_browser_handle: uint, pch_url: cstr, pch_post_data: cstr) -> void = c.SteamAPI_ISteamHTMLSurface_LoadURL
...
public foreign function html_surface_add_header(self: ptr[HTMLSurface], un_browser_handle: uint, pch_key: cstr, pch_value: cstr) -> void = c.SteamAPI_ISteamHTMLSurface_AddHeader
public foreign function html_surface_execute_javascript(self: ptr[HTMLSurface], un_browser_handle: uint, pch_script: cstr) -> void = c.SteamAPI_ISteamHTMLSurface_ExecuteJavascript
...
public foreign function html_surface_find(self: ptr[HTMLSurface], un_browser_handle: uint, pch_search_str: cstr, b_currently_in_find: bool, b_reverse: bool) -> void = c.SteamAPI_ISteamHTMLSurface_Find
...
public foreign function html_surface_set_cookie(self: ptr[HTMLSurface], pch_hostname: cstr, pch_key: cstr, pch_value: cstr, pch_path: cstr, n_expires: uint, b_secure: bool, b_http_only: bool) -> void = c.SteamAPI_ISteamHTMLSurface_SetCookie
...
public foreign function inventory_get_result_item_property(self: ptr[Inventory], result_handle: int, un_item_index: uint, pch_property_name: cstr, pch_value_buffer: ptr[char], pun_value_buffer_size_out: ptr[uint32]) -> bool = c.SteamAPI_ISteamInventory_GetResultItemProperty
...
public foreign function inventory_get_item_definition_property(self: ptr[Inventory], i_definition: int, pch_property_name: cstr, pch_value_buffer: ptr[char], pun_value_buffer_size_out: ptr[uint32]) -> bool = c.SteamAPI_ISteamInventory_GetItemDefinitionProperty
...
public foreign function inventory_remove_property(self: ptr[Inventory], handle: ulong, n_item_id: ulong, pch_property_name: cstr) -> bool = c.SteamAPI_ISteamInventory_RemoveProperty
public foreign function inventory_set_property_string(self: ptr[Inventory], handle: ulong, n_item_id: ulong, pch_property_name: cstr, pch_property_value: cstr) -> bool = c.SteamAPI_ISteamInventory_SetPropertyString
public foreign function inventory_set_property_bool(self: ptr[Inventory], handle: ulong, n_item_id: ulong, pch_property_name: cstr, b_value: bool) -> bool = c.SteamAPI_ISteamInventory_SetPropertyBool
public foreign function inventory_set_property_int_64(self: ptr[Inventory], handle: ulong, n_item_id: ulong, pch_property_name: cstr, n_value: long) -> bool = c.SteamAPI_ISteamInventory_SetPropertyInt64
public foreign function inventory_set_property_float(self: ptr[Inventory], handle: ulong, n_item_id: ulong, pch_property_name: cstr, fl_value: float) -> bool = c.SteamAPI_ISteamInventory_SetPropertyFloat
...
public foreign function inventory_inspect_item(self: ptr[Inventory], p_result_handle: ptr[InventoryResult_t], pch_item_token: cstr) -> bool = c.SteamAPI_ISteamInventory_InspectItem
public foreign function timeline_set_timeline_tooltip(self: ptr[Timeline], pch_description: cstr, fl_time_delta: float) -> void = c.SteamAPI_ISteamTimeline_SetTimelineTooltip
...
public foreign function timeline_start_range_timeline_event(self: ptr[Timeline], pch_title: cstr, pch_description: cstr, pch_icon: cstr, un_priority: uint, fl_start_offset_seconds: float, e_possible_clip: ETimelineEventClipPriority) -> TimelineEventHandle_t = c.SteamAPI_ISteamTimeline_StartRangeTimelineEvent
public foreign function timeline_update_range_timeline_event(self: ptr[Timeline], ul_event: ulong, pch_title: cstr, pch_description: cstr, pch_icon: cstr, un_priority: uint, e_possible_clip: ETimelineEventClipPriority) -> void = c.SteamAPI_ISteamTimeline_UpdateRangeTimelineEvent
...
public foreign function timeline_set_game_phase_id(self: ptr[Timeline], pch_phase_id: cstr) -> void = c.SteamAPI_ISteamTimeline_SetGamePhaseID
public foreign function timeline_does_game_phase_recording_exist(self: ptr[Timeline], pch_phase_id: cstr) -> APICall_t = c.SteamAPI_ISteamTimeline_DoesGamePhaseRecordingExist
public foreign function timeline_add_game_phase_tag(self: ptr[Timeline], pch_tag_name: cstr, pch_tag_icon: cstr, pch_tag_group: cstr, un_priority: uint) -> void = c.SteamAPI_ISteamTimeline_AddGamePhaseTag
public foreign function timeline_set_game_phase_attribute(self: ptr[Timeline], pch_attribute_group: cstr, pch_attribute_value: cstr, un_priority: uint) -> void = c.SteamAPI_ISteamTimeline_SetGamePhaseAttribute
public foreign function timeline_open_overlay_to_game_phase(self: ptr[Timeline], pch_phase_id: cstr) -> void = c.SteamAPI_ISteamTimeline_OpenOverlayToGamePhase
...
public foreign function networking_sockets_create_listen_socket_p_2p(self: ptr[NetworkingSockets], n_local_virtual_port: int, n_options: int, p_options: const_ptr[NetworkingConfigValue_t]) -> HSteamListenSocket = c.SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2P
public foreign function networking_sockets_connect_p_2p(self: ptr[NetworkingSockets], identity_remote: const_ptr[NetworkingIdentity], n_remote_virtual_port: int, n_options: int, p_options: const_ptr[NetworkingConfigValue_t]) -> HSteamNetConnection = c.SteamAPI_ISteamNetworkingSockets_ConnectP2P
...
public foreign function networking_sockets_close_connection(self: ptr[NetworkingSockets], h_peer: uint, n_reason: int, psz_debug: cstr, b_enable_linger: bool) -> bool = c.SteamAPI_ISteamNetworkingSockets_CloseConnection
...
public foreign function networking_sockets_set_connection_name(self: ptr[NetworkingSockets], h_peer: uint, psz_name: cstr) -> void = c.SteamAPI_ISteamNetworkingSockets_SetConnectionName
...
public foreign function networking_sockets_create_socket_pair(self: ptr[NetworkingSockets], p_out_connection_1: ptr[HSteamNetConnection], p_out_connection_2: ptr[HSteamNetConnection], b_use_network_loopback: bool, p_identity_1: const_ptr[NetworkingIdentity], p_identity_2: const_ptr[NetworkingIdentity]) -> bool = c.SteamAPI_ISteamNetworkingSockets_CreateSocketPair
...
public foreign function networking_sockets_connect_p_2p_custom_signaling(self: ptr[NetworkingSockets], p_signaling: ptr[NetworkingConnectionSignaling], p_peer_identity: const_ptr[NetworkingIdentity], n_remote_virtual_port: int, n_options: int, p_options: const_ptr[NetworkingConfigValue_t]) -> HSteamNetConnection = c.SteamAPI_ISteamNetworkingSockets_ConnectP2PCustomSignaling
public foreign function networking_sockets_received_p_2p_custom_signal(self: ptr[NetworkingSockets], p_msg: const_ptr[void], cb_msg: int, p_context: ptr[NetworkingSignalingRecvContext]) -> bool = c.SteamAPI_ISteamNetworkingSockets_ReceivedP2PCustomSignal
...
public foreign function networking_sockets_create_listen_socket_p_2p_fake_ip(self: ptr[NetworkingSockets], idx_fake_port: int, n_options: int, p_options: const_ptr[NetworkingConfigValue_t]) -> HSteamListenSocket = c.SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2PFakeIP
...
public foreign function networking_utils_estimate_ping_time_between_two_locations(self: ptr[NetworkingUtils], location_1: const_ptr[NetworkPingLocation_t], location_2: const_ptr[NetworkPingLocation_t]) -> int = c.SteamAPI_ISteamNetworkingUtils_EstimatePingTimeBetweenTwoLocations
...
public foreign function networking_utils_parse_ping_location_string(self: ptr[NetworkingUtils], psz_string: cstr, result: ptr[NetworkPingLocation_t]) -> bool = c.SteamAPI_ISteamNetworkingUtils_ParsePingLocationString
...
public foreign function networking_utils_is_fake_i_pv_4(self: ptr[NetworkingUtils], n_i_pv_4: uint) -> bool = c.SteamAPI_ISteamNetworkingUtils_IsFakeIPv4
public foreign function networking_utils_get_i_pv_4fake_ip_type(self: ptr[NetworkingUtils], n_i_pv_4: uint) -> ENetworkingFakeIPType = c.SteamAPI_ISteamNetworkingUtils_GetIPv4FakeIPType
...
public foreign function networking_utils_set_global_config_value_int_32(self: ptr[NetworkingUtils], e_value: ENetworkingConfigValue, val: int) -> bool = c.SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueInt32
...
public foreign function networking_utils_set_global_config_value_string(self: ptr[NetworkingUtils], e_value: ENetworkingConfigValue, val: cstr) -> bool = c.SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValueString
...
public foreign function networking_utils_set_connection_config_value_int_32(self: ptr[NetworkingUtils], h_conn: uint, e_value: ENetworkingConfigValue, val: int) -> bool = c.SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueInt32
...
public foreign function networking_utils_set_connection_config_value_string(self: ptr[NetworkingUtils], h_conn: uint, e_value: ENetworkingConfigValue, val: cstr) -> bool = c.SteamAPI_ISteamNetworkingUtils_SetConnectionConfigValueString
...
public foreign function networking_utils_steam_networking_ip_addr_parse_string(self: ptr[NetworkingUtils], p_addr: ptr[NetworkingIPAddr], psz_str: cstr) -> bool = c.SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ParseString
...
public foreign function networking_utils_steam_networking_identity_parse_string(self: ptr[NetworkingUtils], p_identity: ptr[NetworkingIdentity], psz_str: cstr) -> bool = c.SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ParseString
public foreign function game_server_set_product(self: ptr[GameServer], psz_product: cstr) -> void = c.SteamAPI_ISteamGameServer_SetProduct
public foreign function game_server_set_game_description(self: ptr[GameServer], psz_game_description: cstr) -> void = c.SteamAPI_ISteamGameServer_SetGameDescription
public foreign function game_server_set_mod_dir(self: ptr[GameServer], psz_mod_dir: cstr) -> void = c.SteamAPI_ISteamGameServer_SetModDir
...
public foreign function game_server_log_on(self: ptr[GameServer], psz_token: cstr) -> void = c.SteamAPI_ISteamGameServer_LogOn
...
public foreign function game_server_set_server_name(self: ptr[GameServer], psz_server_name: cstr) -> void = c.SteamAPI_ISteamGameServer_SetServerName
public foreign function game_server_set_map_name(self: ptr[GameServer], psz_map_name: cstr) -> void = c.SteamAPI_ISteamGameServer_SetMapName
...
public foreign function game_server_set_spectator_server_name(self: ptr[GameServer], psz_spectator_server_name: cstr) -> void = c.SteamAPI_ISteamGameServer_SetSpectatorServerName
...
public foreign function game_server_set_key_value(self: ptr[GameServer], p_key: cstr, p_value: cstr) -> void = c.SteamAPI_ISteamGameServer_SetKeyValue
public foreign function game_server_set_game_tags(self: ptr[GameServer], pch_game_tags: cstr) -> void = c.SteamAPI_ISteamGameServer_SetGameTags
public foreign function game_server_set_game_data(self: ptr[GameServer], pch_game_data: cstr) -> void = c.SteamAPI_ISteamGameServer_SetGameData
public foreign function game_server_set_region(self: ptr[GameServer], psz_region: cstr) -> void = c.SteamAPI_ISteamGameServer_SetRegion
...
public foreign function game_server_b_update_user_data(self: ptr[GameServer], steam_id_user: ulong, pch_player_name: cstr, u_score: uint) -> bool = c.SteamAPI_ISteamGameServer_BUpdateUserData
...
public foreign function game_server_stats_get_user_stat_int_32(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, p_data: ptr[int32]) -> bool = c.SteamAPI_ISteamGameServerStats_GetUserStatInt32
public foreign function game_server_stats_get_user_stat_float(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, p_data: ptr[float]) -> bool = c.SteamAPI_ISteamGameServerStats_GetUserStatFloat
public foreign function game_server_stats_get_user_achievement(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, pb_achieved: ptr[bool]) -> bool = c.SteamAPI_ISteamGameServerStats_GetUserAchievement
public foreign function game_server_stats_set_user_stat_int_32(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, n_data: int) -> bool = c.SteamAPI_ISteamGameServerStats_SetUserStatInt32
public foreign function game_server_stats_set_user_stat_float(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, f_data: float) -> bool = c.SteamAPI_ISteamGameServerStats_SetUserStatFloat
public foreign function game_server_stats_update_user_avg_rate_stat(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr, fl_count_this_session: float, d_session_length: double) -> bool = c.SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat
public foreign function game_server_stats_set_user_achievement(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr) -> bool = c.SteamAPI_ISteamGameServerStats_SetUserAchievement
public foreign function game_server_stats_clear_user_achievement(self: ptr[GameServerStats], steam_id_user: ulong, pch_name: cstr) -> bool = c.SteamAPI_ISteamGameServerStats_ClearUserAchievement
...
public foreign function gameserveritem_t_set_name(self: ptr[gameserveritem_t], p_name: cstr) -> void = c.SteamAPI_gameserveritem_t_SetName
public foreign function networking_ip_addr_clear(self: ptr[NetworkingIPAddr]) -> void = c.SteamAPI_SteamNetworkingIPAddr_Clear
public foreign function networking_ip_addr_is_i_pv_6all_zeros(self: ptr[NetworkingIPAddr]) -> bool = c.SteamAPI_SteamNetworkingIPAddr_IsIPv6AllZeros
public foreign function networking_ip_addr_set_i_pv_6(self: ptr[NetworkingIPAddr], ipv_6: const_ptr[uint8], n_port: ushort) -> void = c.SteamAPI_SteamNetworkingIPAddr_SetIPv6
public foreign function networking_ip_addr_set_i_pv_4(self: ptr[NetworkingIPAddr], n_ip: uint, n_port: ushort) -> void = c.SteamAPI_SteamNetworkingIPAddr_SetIPv4
public foreign function networking_ip_addr_is_i_pv_4(self: ptr[NetworkingIPAddr]) -> bool = c.SteamAPI_SteamNetworkingIPAddr_IsIPv4
public foreign function networking_ip_addr_get_i_pv_4(self: ptr[NetworkingIPAddr]) -> uint32 = c.SteamAPI_SteamNetworkingIPAddr_GetIPv4
public foreign function networking_ip_addr_set_i_pv_6local_host(self: ptr[NetworkingIPAddr], n_port: ushort) -> void = c.SteamAPI_SteamNetworkingIPAddr_SetIPv6LocalHost
...
public foreign function networking_ip_addr_parse_string(self: ptr[NetworkingIPAddr], psz_str: cstr) -> bool = c.SteamAPI_SteamNetworkingIPAddr_ParseString
...
public foreign function networking_identity_set_steam_id_64(self: ptr[NetworkingIdentity], steam_id: ulong) -> void = c.SteamAPI_SteamNetworkingIdentity_SetSteamID64
public foreign function networking_identity_get_steam_id_64(self: ptr[NetworkingIdentity]) -> uint64 = c.SteamAPI_SteamNetworkingIdentity_GetSteamID64
public foreign function networking_identity_set_xbox_pairwise_id(self: ptr[NetworkingIdentity], psz_string: cstr) -> bool = c.SteamAPI_SteamNetworkingIdentity_SetXboxPairwiseID
...
public foreign function networking_identity_set_i_pv_4addr(self: ptr[NetworkingIdentity], n_i_pv_4: uint, n_port: ushort) -> void = c.SteamAPI_SteamNetworkingIdentity_SetIPv4Addr
public foreign function networking_identity_get_i_pv_4(self: ptr[NetworkingIdentity]) -> uint32 = c.SteamAPI_SteamNetworkingIdentity_GetIPv4
...
public foreign function networking_identity_set_generic_string(self: ptr[NetworkingIdentity], psz_string: cstr) -> bool = c.SteamAPI_SteamNetworkingIdentity_SetGenericString
...
public foreign function networking_identity_parse_string(self: ptr[NetworkingIdentity], psz_str: cstr) -> bool = c.SteamAPI_SteamNetworkingIdentity_ParseString
...
public foreign function networking_config_value_t_set_int_32(self: ptr[NetworkingConfigValue_t], e_val: ENetworkingConfigValue, data: int) -> void = c.SteamAPI_SteamNetworkingConfigValue_t_SetInt32
public foreign function networking_config_value_t_set_int_64(self: ptr[NetworkingConfigValue_t], e_val: ENetworkingConfigValue, data: ptr_int) -> void = c.SteamAPI_SteamNetworkingConfigValue_t_SetInt64
...
public foreign function networking_config_value_t_set_string(self: ptr[NetworkingConfigValue_t], e_val: ENetworkingConfigValue, data: cstr) -> void = c.SteamAPI_SteamNetworkingConfigValue_t_SetString
