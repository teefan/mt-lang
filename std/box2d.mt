...
public type ContactId = c.b2ContactId
...
public type MotionLocks = c.b2MotionLocks
...
public type JointDef = c.b2JointDef
...
public type JointEvent = c.b2JointEvent
public type JointEvents = c.b2JointEvents
...
public type ContactDrawType = c.b2ContactDrawType
...
public const b2_nullContactId: ContactId = c.b2_nullContactId
public const B2_ENABLE_VALIDATION: int = c.B2_ENABLE_VALIDATION
...
public foreign function set_log_fcn(log_fcn: ptr[LogFcn]) -> void = c.b2SetLogFcn
public foreign function get_version() -> Version = c.b2GetVersion
public foreign function internal_assert(condition: cstr, file_name: cstr, line_number: int) -> int = c.b2InternalAssert
...
public foreign function is_valid_vec_2(v: Vec2) -> bool = c.b2IsValidVec2
public foreign function is_valid_rotation(q: Rot) -> bool = c.b2IsValidRotation
public foreign function is_valid_transform(t: Transform) -> bool = c.b2IsValidTransform
...
public foreign function atan_2(y: float, x: float) -> float = c.b2Atan2
public foreign function compute_cos_sin(radians: float) -> CosSin = c.b2ComputeCosSin
public foreign function compute_rotation_between_unit_vectors(v_1: Vec2, v_2: Vec2) -> Rot = c.b2ComputeRotationBetweenUnitVectors
...
public foreign function point_in_circle(shape: const_ptr[Circle], point: Vec2) -> bool = c.b2PointInCircle
public foreign function point_in_capsule(shape: const_ptr[Capsule], point: Vec2) -> bool = c.b2PointInCapsule
public foreign function point_in_polygon(shape: const_ptr[Polygon], point: Vec2) -> bool = c.b2PointInPolygon
public foreign function ray_cast_circle(shape: const_ptr[Circle], input: const_ptr[RayCastInput]) -> CastOutput = c.b2RayCastCircle
public foreign function ray_cast_capsule(shape: const_ptr[Capsule], input: const_ptr[RayCastInput]) -> CastOutput = c.b2RayCastCapsule
public foreign function ray_cast_segment(shape: const_ptr[Segment], input: const_ptr[RayCastInput], one_sided: bool) -> CastOutput = c.b2RayCastSegment
public foreign function ray_cast_polygon(shape: const_ptr[Polygon], input: const_ptr[RayCastInput]) -> CastOutput = c.b2RayCastPolygon
public foreign function shape_cast_circle(shape: const_ptr[Circle], input: const_ptr[ShapeCastInput]) -> CastOutput = c.b2ShapeCastCircle
public foreign function shape_cast_capsule(shape: const_ptr[Capsule], input: const_ptr[ShapeCastInput]) -> CastOutput = c.b2ShapeCastCapsule
public foreign function shape_cast_segment(shape: const_ptr[Segment], input: const_ptr[ShapeCastInput]) -> CastOutput = c.b2ShapeCastSegment
public foreign function shape_cast_polygon(shape: const_ptr[Polygon], input: const_ptr[ShapeCastInput]) -> CastOutput = c.b2ShapeCastPolygon
...
public foreign function segment_distance(p_1: Vec2, q_1: Vec2, p_2: Vec2, q_2: Vec2) -> SegmentDistanceResult = c.b2SegmentDistance
...
public foreign function dynamic_tree_query_all(tree: const_ptr[DynamicTree], aabb: AABB, callback: ptr[TreeQueryCallbackFcn], context: ptr[void]) -> TreeStats = c.b2DynamicTree_QueryAll
...
public foreign function world_get_joint_events(world_id: WorldId) -> JointEvents = c.b2World_GetJointEvents
...
public foreign function world_set_contact_recycle_distance(world_id: WorldId, recycle_distance: float) -> void = c.b2World_SetContactRecycleDistance
public foreign function world_get_contact_recycle_distance(world_id: WorldId) -> float = c.b2World_GetContactRecycleDistance
...
public foreign function world_set_worker_count(world_id: WorldId, count: int) -> void = c.b2World_SetWorkerCount
public foreign function world_get_worker_count(world_id: WorldId) -> int = c.b2World_GetWorkerCount
...
public foreign function body_set_name(body_id: BodyId, name: cstr) -> void = c.b2Body_SetName
...
public foreign function body_set_target_transform(body_id: BodyId, target: Transform, time_step: float, wake: bool) -> void = c.b2Body_SetTargetTransform
...
public foreign function body_clear_forces(body_id: BodyId) -> void = c.b2Body_ClearForces
...
public foreign function body_wake_touching(body_id: BodyId) -> void = c.b2Body_WakeTouching
...
public foreign function body_set_motion_locks(body_id: BodyId, locks: MotionLocks) -> void = c.b2Body_SetMotionLocks
public foreign function body_get_motion_locks(body_id: BodyId) -> MotionLocks = c.b2Body_GetMotionLocks
...
public foreign function shape_set_user_material(shape_id: ShapeId, material: ptr_uint) -> void = c.b2Shape_SetUserMaterial
public foreign function shape_get_user_material(shape_id: ShapeId) -> ulong = c.b2Shape_GetUserMaterial
public foreign function shape_set_surface_material(shape_id: ShapeId, surface_material: const_ptr[SurfaceMaterial]) -> void = c.b2Shape_SetSurfaceMaterial
...
public foreign function shape_get_sensor_data(shape_id: ShapeId, visitor_ids: ptr[ShapeId], capacity: int) -> int = c.b2Shape_GetSensorData
public foreign function shape_get_aabb(shape_id: ShapeId) -> AABB = c.b2Shape_GetAABB
public foreign function shape_compute_mass_data(shape_id: ShapeId) -> MassData = c.b2Shape_ComputeMassData
public foreign function shape_get_closest_point(shape_id: ShapeId, target: Vec2) -> Vec2 = c.b2Shape_GetClosestPoint
public foreign function shape_apply_wind(shape_id: ShapeId, wind: Vec2, drag: float, lift: float, wake: bool) -> void = c.b2Shape_ApplyWind
...
public foreign function chain_get_surface_material_count(chain_id: ChainId) -> int = c.b2Chain_GetSurfaceMaterialCount
public foreign function chain_set_surface_material(chain_id: ChainId, material: const_ptr[SurfaceMaterial], material_index: int) -> void = c.b2Chain_SetSurfaceMaterial
public foreign function chain_get_surface_material(chain_id: ChainId, material_index: int) -> SurfaceMaterial = c.b2Chain_GetSurfaceMaterial
public foreign function chain_is_valid(id: ChainId) -> bool = c.b2Chain_IsValid
public foreign function destroy_joint(joint_id: JointId, wake_attached: bool) -> void = c.b2DestroyJoint
...
public foreign function joint_set_local_frame_a(joint_id: JointId, local_frame: Transform) -> void = c.b2Joint_SetLocalFrameA
public foreign function joint_get_local_frame_a(joint_id: JointId) -> Transform = c.b2Joint_GetLocalFrameA
public foreign function joint_set_local_frame_b(joint_id: JointId, local_frame: Transform) -> void = c.b2Joint_SetLocalFrameB
public foreign function joint_get_local_frame_b(joint_id: JointId) -> Transform = c.b2Joint_GetLocalFrameB
...
public foreign function joint_set_force_threshold(joint_id: JointId, threshold: float) -> void = c.b2Joint_SetForceThreshold
public foreign function joint_get_force_threshold(joint_id: JointId) -> float = c.b2Joint_GetForceThreshold
public foreign function joint_set_torque_threshold(joint_id: JointId, threshold: float) -> void = c.b2Joint_SetTorqueThreshold
public foreign function joint_get_torque_threshold(joint_id: JointId) -> float = c.b2Joint_GetTorqueThreshold
...
public foreign function distance_joint_set_spring_force_range(joint_id: JointId, lower_force: float, upper_force: float) -> void = c.b2DistanceJoint_SetSpringForceRange
public foreign function distance_joint_get_spring_force_range(joint_id: JointId, lower_force: ptr[float], upper_force: ptr[float]) -> void = c.b2DistanceJoint_GetSpringForceRange
...
public foreign function motor_joint_set_linear_velocity(joint_id: JointId, velocity: Vec2) -> void = c.b2MotorJoint_SetLinearVelocity
public foreign function motor_joint_get_linear_velocity(joint_id: JointId) -> Vec2 = c.b2MotorJoint_GetLinearVelocity
public foreign function motor_joint_set_angular_velocity(joint_id: JointId, velocity: float) -> void = c.b2MotorJoint_SetAngularVelocity
public foreign function motor_joint_get_angular_velocity(joint_id: JointId) -> float = c.b2MotorJoint_GetAngularVelocity
public foreign function motor_joint_set_max_velocity_force(joint_id: JointId, max_force: float) -> void = c.b2MotorJoint_SetMaxVelocityForce
public foreign function motor_joint_get_max_velocity_force(joint_id: JointId) -> float = c.b2MotorJoint_GetMaxVelocityForce
public foreign function motor_joint_set_max_velocity_torque(joint_id: JointId, max_torque: float) -> void = c.b2MotorJoint_SetMaxVelocityTorque
public foreign function motor_joint_get_max_velocity_torque(joint_id: JointId) -> float = c.b2MotorJoint_GetMaxVelocityTorque
public foreign function motor_joint_set_linear_hertz(joint_id: JointId, hertz: float) -> void = c.b2MotorJoint_SetLinearHertz
public foreign function motor_joint_get_linear_hertz(joint_id: JointId) -> float = c.b2MotorJoint_GetLinearHertz
public foreign function motor_joint_set_linear_damping_ratio(joint_id: JointId, damping: float) -> void = c.b2MotorJoint_SetLinearDampingRatio
public foreign function motor_joint_get_linear_damping_ratio(joint_id: JointId) -> float = c.b2MotorJoint_GetLinearDampingRatio
public foreign function motor_joint_set_angular_hertz(joint_id: JointId, hertz: float) -> void = c.b2MotorJoint_SetAngularHertz
public foreign function motor_joint_get_angular_hertz(joint_id: JointId) -> float = c.b2MotorJoint_GetAngularHertz
public foreign function motor_joint_set_angular_damping_ratio(joint_id: JointId, damping: float) -> void = c.b2MotorJoint_SetAngularDampingRatio
public foreign function motor_joint_get_angular_damping_ratio(joint_id: JointId) -> float = c.b2MotorJoint_GetAngularDampingRatio
public foreign function motor_joint_set_max_spring_force(joint_id: JointId, max_force: float) -> void = c.b2MotorJoint_SetMaxSpringForce
public foreign function motor_joint_get_max_spring_force(joint_id: JointId) -> float = c.b2MotorJoint_GetMaxSpringForce
public foreign function motor_joint_set_max_spring_torque(joint_id: JointId, max_torque: float) -> void = c.b2MotorJoint_SetMaxSpringTorque
public foreign function motor_joint_get_max_spring_torque(joint_id: JointId) -> float = c.b2MotorJoint_GetMaxSpringTorque
...
public foreign function contact_is_valid(id: ContactId) -> bool = c.b2Contact_IsValid
public foreign function contact_get_data(contact_id: ContactId) -> ContactData = c.b2Contact_GetData
