...
pub const B2_ENABLE_VALIDATION: i32 = c.B2_ENABLE_VALIDATION
pub const B2_HASH_INIT: i32 = c.B2_HASH_INIT
pub const B2_PI: f32 = c.B2_PI
...
pub foreign def body_set_type(body_id: BodyId, type: BodyType) -> void = c.b2Body_SetType
