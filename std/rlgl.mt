...
public type Matrix = raylib.Matrix
...
public foreign function vertex_2i(x: int, y: int) -> void = c.rlVertex2i
public foreign function vertex_2f(x: float, y: float) -> void = c.rlVertex2f
public foreign function vertex_3f(x: float, y: float, z: float) -> void = c.rlVertex3f
public foreign function tex_coord_2f(x: float, y: float) -> void = c.rlTexCoord2f
public foreign function normal_3f(x: float, y: float, z: float) -> void = c.rlNormal3f
public foreign function color_4ub(r: ubyte, g: ubyte, b: ubyte, a: ubyte) -> void = c.rlColor4ub
public foreign function color_3f(x: float, y: float, z: float) -> void = c.rlColor3f
public foreign function color_4f(x: float, y: float, z: float, w: float) -> void = c.rlColor4f
...
public foreign function get_proc_address(proc_name: cstr) -> ptr[void]? = c.rlGetProcAddress
...
public foreign function get_gl_texture_formats(format: int, gl_internal_format: ptr[uint], gl_format: ptr[uint], gl_type: ptr[uint]) -> void = c.rlGetGlTextureFormats
...
public foreign function gen_texture_mipmaps(id: uint, width: int, height: int, format: int, mipmaps: ptr[int]) -> void = c.rlGenTextureMipmaps
...
public foreign function load_shader(code: cstr, type_: int) -> uint = c.rlLoadShader
...
public foreign function get_location_uniform(id: uint, uniform_name: cstr) -> int = c.rlGetLocationUniform
public foreign function get_location_attrib(id: uint, attrib_name: cstr) -> int = c.rlGetLocationAttrib
