...
pub const RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEINDICES: i32 = c.RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEINDICES
...
pub foreign def load_texture[T](data: ptr[T] as const_ptr[void], width: i32, height: i32, format: i32, mipmap_count: i32) -> u32 = c.rlLoadTexture
pub foreign def load_texture_depth(width: i32, height: i32, use_render_buffer: bool) -> u32 = c.rlLoadTextureDepth
pub foreign def load_texture_cubemap[T](data: ptr[T] as const_ptr[void], size: i32, format: i32, mipmap_count: i32) -> u32 = c.rlLoadTextureCubemap
...
pub foreign def load_shader_buffer[T](size: u32, data: ptr[T] as const_ptr[void], usage_hint: i32) -> u32 = c.rlLoadShaderBuffer
