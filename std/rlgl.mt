...
pub foreign def load_vertex_buffer(buffer: ptr[void], size: i32, dynamic: bool) -> u32 = c.rlLoadVertexBuffer
pub foreign def load_vertex_buffer_element(buffer: ptr[void], size: i32, dynamic: bool) -> u32 = c.rlLoadVertexBufferElement
pub foreign def update_vertex_buffer(buffer_id: u32, data: ptr[void], data_size: i32, offset: i32) -> void = c.rlUpdateVertexBuffer
pub foreign def update_vertex_buffer_elements(id: u32, data: ptr[void], data_size: i32, offset: i32) -> void = c.rlUpdateVertexBufferElements
...
pub foreign def set_vertex_attribute_default(loc_index: i32, value: ptr[void], attrib_type: i32, count: i32) -> void = c.rlSetVertexAttributeDefault
...
pub foreign def load_texture(data: ptr[void], width: i32, height: i32, format: i32, mipmap_count: i32) -> u32 = c.rlLoadTexture
pub foreign def load_texture_depth(width: i32, height: i32, use_render_buffer: bool) -> u32 = c.rlLoadTextureDepth
pub foreign def load_texture_cubemap(data: ptr[void], size: i32, format: i32, mipmap_count: i32) -> u32 = c.rlLoadTextureCubemap
pub foreign def update_texture(id: u32, offset_x: i32, offset_y: i32, width: i32, height: i32, format: i32, data: ptr[void]) -> void = c.rlUpdateTexture
...
pub foreign def compile_shader(shader_code: cstr, type: i32) -> u32 = c.rlCompileShader
...
pub foreign def set_uniform(loc_index: i32, value: ptr[void], uniform_type: i32, count: i32) -> void = c.rlSetUniform
...
pub foreign def load_compute_shader_program(shader_id: u32) -> u32 = c.rlLoadComputeShaderProgram
pub foreign def compute_shader_dispatch(group_x: u32, group_y: u32, group_z: u32) -> void = c.rlComputeShaderDispatch
pub foreign def load_shader_buffer(size: u32, data: ptr[void], usage_hint: i32) -> u32 = c.rlLoadShaderBuffer
pub foreign def unload_shader_buffer(ssbo_id: u32) -> void = c.rlUnloadShaderBuffer
pub foreign def update_shader_buffer(id: u32, data: ptr[void], data_size: u32, offset: u32) -> void = c.rlUpdateShaderBuffer
pub foreign def bind_shader_buffer(id: u32, index: u32) -> void = c.rlBindShaderBuffer
pub foreign def read_shader_buffer(id: u32, dest: ptr[void], count: u32, offset: u32) -> void = c.rlReadShaderBuffer
