...
pub foreign def compile_shader(shader_code: cstr, type: i32) -> u32 = c.rlLoadShader
...
pub foreign def load_compute_shader_program(shader_id: u32) -> u32 = c.rlLoadShaderProgramCompute
