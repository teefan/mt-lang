...
public foreign function get_environment_variable(env: ptr[Environment], name: cstr) -> cstr? = c.SDL_GetEnvironmentVariable
public foreign function get_environment_variables(env: ptr[Environment]) -> ptr[ptr[char]]? = c.SDL_GetEnvironmentVariables
public foreign function set_environment_variable(env: ptr[Environment], name: cstr, value: cstr, overwrite: bool) -> bool = c.SDL_SetEnvironmentVariable
public foreign function unset_environment_variable(env: ptr[Environment], name: cstr) -> bool = c.SDL_UnsetEnvironmentVariable
public foreign function destroy_environment(env: ptr[Environment]) -> void = c.SDL_DestroyEnvironment
public foreign function getenv(name: cstr) -> cstr? = c.SDL_getenv
public foreign function getenv_unsafe(name: cstr) -> cstr? = c.SDL_getenv_unsafe
public foreign function setenv_unsafe(name: cstr, value: cstr, overwrite: int) -> int = c.SDL_setenv_unsafe
public foreign function unsetenv_unsafe(name: cstr) -> int = c.SDL_unsetenv_unsafe
...
public foreign function crc_16(crc: ushort, data: const_ptr[void], len: ptr_uint) -> ushort = c.SDL_crc16
public foreign function crc_32(crc: uint, data: const_ptr[void], len: ptr_uint) -> uint = c.SDL_crc32
public foreign function murmur_3_32(data: const_ptr[void], len: ptr_uint, seed: uint) -> uint = c.SDL_murmur3_32
...
public foreign function memset_4(dst: ptr[void], val: uint, dwords: ptr_uint) -> ptr[void] = c.SDL_memset4
public foreign function memcmp(s_1: const_ptr[void], s_2: const_ptr[void], len: ptr_uint) -> int = c.SDL_memcmp
...
public foreign function wcscmp(str_1: const_ptr[int], str_2: const_ptr[int]) -> int = c.SDL_wcscmp
public foreign function wcsncmp(str_1: const_ptr[int], str_2: const_ptr[int], maxlen: ptr_uint) -> int = c.SDL_wcsncmp
public foreign function wcscasecmp(str_1: const_ptr[int], str_2: const_ptr[int]) -> int = c.SDL_wcscasecmp
public foreign function wcsncasecmp(str_1: const_ptr[int], str_2: const_ptr[int], maxlen: ptr_uint) -> int = c.SDL_wcsncasecmp
public foreign function wcstol(str: const_ptr[int], endp: ptr[ptr[int]], base: int) -> ptr_int = c.SDL_wcstol
public foreign function strlen(str: cstr) -> ptr_uint = c.SDL_strlen
public foreign function strnlen(str: cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strnlen
public foreign function strlcpy(dst: ptr[char], src: cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strlcpy
public foreign function utf_8strlcpy(dst: ptr[char], src: cstr, dst_bytes: ptr_uint) -> ptr_uint = c.SDL_utf8strlcpy
public foreign function strlcat(dst: ptr[char], src: cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strlcat
public foreign function strdup(str: cstr) -> ptr[char]? = c.SDL_strdup
public foreign function strndup(str: cstr, maxlen: ptr_uint) -> ptr[char] = c.SDL_strndup
public foreign function strrev(str: ptr[char]) -> ptr[char] = c.SDL_strrev
public foreign function strupr(str: ptr[char]) -> ptr[char] = c.SDL_strupr
public foreign function strlwr(str: ptr[char]) -> ptr[char] = c.SDL_strlwr
public foreign function strchr(str: cstr, c: int) -> ptr[char]? = c.SDL_strchr
public foreign function strrchr(str: cstr, c: int) -> ptr[char]? = c.SDL_strrchr
public foreign function strstr(haystack: cstr, needle: cstr) -> ptr[char]? = c.SDL_strstr
public foreign function strnstr(haystack: cstr, needle: cstr, maxlen: ptr_uint) -> ptr[char]? = c.SDL_strnstr
public foreign function strcasestr(haystack: cstr, needle: cstr) -> ptr[char]? = c.SDL_strcasestr
public foreign function strtok_r(str: ptr[char]?, delim: cstr, saveptr: ptr[ptr[char]]) -> ptr[char]? = c.SDL_strtok_r
public foreign function utf_8strlen(str: cstr) -> ptr_uint = c.SDL_utf8strlen
public foreign function utf_8strnlen(str: cstr, bytes: ptr_uint) -> ptr_uint = c.SDL_utf8strnlen
public foreign function itoa(value: int, str: ptr[char], radix: int) -> ptr[char] = c.SDL_itoa
public foreign function uitoa(value: uint, str: ptr[char], radix: int) -> ptr[char] = c.SDL_uitoa
public foreign function ltoa(value: ptr_int, str: ptr[char], radix: int) -> ptr[char] = c.SDL_ltoa
public foreign function ultoa(value: ptr_uint, str: ptr[char], radix: int) -> ptr[char] = c.SDL_ultoa
public foreign function lltoa(value: long, str: ptr[char], radix: int) -> ptr[char] = c.SDL_lltoa
public foreign function ulltoa(value: ulong, str: ptr[char], radix: int) -> ptr[char] = c.SDL_ulltoa
public foreign function atoi(str: cstr) -> int = c.SDL_atoi
public foreign function atof(str: cstr) -> double = c.SDL_atof
public foreign function strtol(str: cstr, endp: ptr[ptr[char]], base: int) -> ptr_int = c.SDL_strtol
public foreign function strtoul(str: cstr, endp: ptr[ptr[char]], base: int) -> ptr_uint = c.SDL_strtoul
public foreign function strtoll(str: cstr, endp: ptr[ptr[char]], base: int) -> long = c.SDL_strtoll
public foreign function strtoull(str: cstr, endp: ptr[ptr[char]], base: int) -> ulong = c.SDL_strtoull
public foreign function strtod(str: cstr, endp: ptr[ptr[char]]) -> double = c.SDL_strtod
public foreign function strcmp(str_1: cstr, str_2: cstr) -> int = c.SDL_strcmp
public foreign function strncmp(str_1: cstr, str_2: cstr, maxlen: ptr_uint) -> int = c.SDL_strncmp
public foreign function strcasecmp(str_1: cstr, str_2: cstr) -> int = c.SDL_strcasecmp
public foreign function strncasecmp(str_1: cstr, str_2: cstr, maxlen: ptr_uint) -> int = c.SDL_strncasecmp
public foreign function strpbrk(str: cstr, breakset: cstr) -> ptr[char] = c.SDL_strpbrk
public foreign function step_utf_8(pstr: ptr[cstr], pslen: ptr[ptr_uint]?) -> uint = c.SDL_StepUTF8
public foreign function step_back_utf_8(start: cstr, pstr: ptr[cstr]) -> uint = c.SDL_StepBackUTF8
public foreign function ucs_4to_utf_8(codepoint: uint, dst: ptr[char]) -> ptr[char] = c.SDL_UCS4ToUTF8
public foreign function vsscanf(text: cstr, fmt: cstr, ap: va_list) -> int = c.SDL_vsscanf
public foreign function vsnprintf(text: ptr[char], maxlen: ptr_uint, fmt: cstr, ap: va_list) -> int = c.SDL_vsnprintf
public foreign function vswprintf(text: ptr[int], maxlen: ptr_uint, fmt: const_ptr[int], ap: va_list) -> int = c.SDL_vswprintf
public foreign function vasprintf(strp: ptr[ptr[char]], fmt: cstr, ap: va_list) -> int = c.SDL_vasprintf
...
public foreign function atan_2(y: double, x: double) -> double = c.SDL_atan2
public foreign function atan_2f(y: float, x: float) -> float = c.SDL_atan2f
...
public foreign function log_10(x: double) -> double = c.SDL_log10
public foreign function log_10f(x: float) -> float = c.SDL_log10f
...
public foreign function iconv_open(tocode: cstr, fromcode: cstr) -> iconv_t = c.SDL_iconv_open
...
public foreign function iconv_string(tocode: cstr, fromcode: cstr, inbuf: cstr, inbytesleft: ptr_uint) -> ptr[char]? = c.SDL_iconv_string
public foreign function report_assertion(data: ptr[AssertData], func: cstr, file: cstr, line: int) -> AssertState = c.SDL_ReportAssertion
...
public foreign function async_io_from_file(file: cstr, mode: cstr) -> ptr[AsyncIO]? = c.SDL_AsyncIOFromFile
...
public foreign function load_file_async(file: cstr, queue: ptr[AsyncIOQueue], userdata: ptr[void]) -> bool = c.SDL_LoadFileAsync
...
public foreign function compare_and_swap_atomic_u_32(a: ptr[AtomicU32], oldval: uint, newval: uint) -> bool = c.SDL_CompareAndSwapAtomicU32
public foreign function set_atomic_u_32(a: ptr[AtomicU32], v: uint) -> uint = c.SDL_SetAtomicU32
public foreign function get_atomic_u_32(a: ptr[AtomicU32]) -> uint = c.SDL_GetAtomicU32
public foreign function add_atomic_u_32(a: ptr[AtomicU32], v: int) -> uint = c.SDL_AddAtomicU32
...
public foreign function set_error_v(fmt: cstr, ap: va_list) -> bool = c.SDL_SetErrorV
...
public foreign function set_pointer_property_with_cleanup(props: uint, name: cstr, value: ptr[void]?, cleanup: fn(arg0: ptr[void], arg1: ptr[void]) -> void, userdata: ptr[void]) -> bool = c.SDL_SetPointerPropertyWithCleanup
public foreign function set_pointer_property(props: uint, name: cstr, value: ptr[void]?) -> bool = c.SDL_SetPointerProperty
public foreign function set_string_property(props: uint, name: cstr, value: cstr?) -> bool = c.SDL_SetStringProperty
public foreign function set_number_property(props: uint, name: cstr, value: ptr_int) -> bool = c.SDL_SetNumberProperty
public foreign function set_float_property(props: uint, name: cstr, value: float) -> bool = c.SDL_SetFloatProperty
public foreign function set_boolean_property(props: uint, name: cstr, value: bool) -> bool = c.SDL_SetBooleanProperty
public foreign function has_property(props: uint, name: cstr) -> bool = c.SDL_HasProperty
public foreign function get_property_type(props: uint, name: cstr) -> PropertyType = c.SDL_GetPropertyType
public foreign function get_pointer_property(props: uint, name: cstr, default_value: ptr[void]) -> ptr[void] = c.SDL_GetPointerProperty
public foreign function get_string_property(props: uint, name: cstr, default_value: cstr) -> cstr = c.SDL_GetStringProperty
public foreign function get_number_property(props: uint, name: cstr, default_value: ptr_int) -> ptr_int = c.SDL_GetNumberProperty
public foreign function get_float_property(props: uint, name: cstr, default_value: float) -> float = c.SDL_GetFloatProperty
public foreign function get_boolean_property(props: uint, name: cstr, default_value: bool) -> bool = c.SDL_GetBooleanProperty
public foreign function clear_property(props: uint, name: cstr) -> bool = c.SDL_ClearProperty
...
public foreign function create_thread_runtime(fn_: fn(arg0: ptr[void]) -> int, name: cstr, data: ptr[void], pfn_begin_thread: fn() -> void, pfn_end_thread: fn() -> void) -> ptr[Thread]? = c.SDL_CreateThreadRuntime
...
public foreign function io_from_file(file: cstr, mode: cstr) -> ptr[IOStream]? = c.SDL_IOFromFile
...
public foreign function i_ovprintf(context: ptr[IOStream], fmt: cstr, ap: va_list) -> ptr_uint = c.SDL_IOvprintf
...
public foreign function load_file(file: cstr, datasize: ptr[ptr_uint]) -> ptr[void]? = c.SDL_LoadFile
...
public foreign function save_file(file: cstr, data: const_ptr[void]?, datasize: ptr_uint) -> bool = c.SDL_SaveFile
public foreign function read_u_8(src: ptr[IOStream], value: ptr[ubyte]) -> bool = c.SDL_ReadU8
public foreign function read_s_8(src: ptr[IOStream], value: ptr[byte]) -> bool = c.SDL_ReadS8
public foreign function read_u_16le(src: ptr[IOStream], value: ptr[ushort]) -> bool = c.SDL_ReadU16LE
public foreign function read_s_16le(src: ptr[IOStream], value: ptr[short]) -> bool = c.SDL_ReadS16LE
public foreign function read_u_16be(src: ptr[IOStream], value: ptr[ushort]) -> bool = c.SDL_ReadU16BE
public foreign function read_s_16be(src: ptr[IOStream], value: ptr[short]) -> bool = c.SDL_ReadS16BE
public foreign function read_u_32le(src: ptr[IOStream], value: ptr[uint]) -> bool = c.SDL_ReadU32LE
public foreign function read_s_32le(src: ptr[IOStream], value: ptr[int]) -> bool = c.SDL_ReadS32LE
public foreign function read_u_32be(src: ptr[IOStream], value: ptr[uint]) -> bool = c.SDL_ReadU32BE
public foreign function read_s_32be(src: ptr[IOStream], value: ptr[int]) -> bool = c.SDL_ReadS32BE
public foreign function read_u_64le(src: ptr[IOStream], value: ptr[ptr_uint]) -> bool = c.SDL_ReadU64LE
public foreign function read_s_64le(src: ptr[IOStream], value: ptr[ptr_int]) -> bool = c.SDL_ReadS64LE
public foreign function read_u_64be(src: ptr[IOStream], value: ptr[ptr_uint]) -> bool = c.SDL_ReadU64BE
public foreign function read_s_64be(src: ptr[IOStream], value: ptr[ptr_int]) -> bool = c.SDL_ReadS64BE
public foreign function write_u_8(dst: ptr[IOStream], value: ubyte) -> bool = c.SDL_WriteU8
public foreign function write_s_8(dst: ptr[IOStream], value: byte) -> bool = c.SDL_WriteS8
public foreign function write_u_16le(dst: ptr[IOStream], value: ushort) -> bool = c.SDL_WriteU16LE
public foreign function write_s_16le(dst: ptr[IOStream], value: short) -> bool = c.SDL_WriteS16LE
public foreign function write_u_16be(dst: ptr[IOStream], value: ushort) -> bool = c.SDL_WriteU16BE
public foreign function write_s_16be(dst: ptr[IOStream], value: short) -> bool = c.SDL_WriteS16BE
public foreign function write_u_32le(dst: ptr[IOStream], value: uint) -> bool = c.SDL_WriteU32LE
public foreign function write_s_32le(dst: ptr[IOStream], value: int) -> bool = c.SDL_WriteS32LE
public foreign function write_u_32be(dst: ptr[IOStream], value: uint) -> bool = c.SDL_WriteU32BE
public foreign function write_s_32be(dst: ptr[IOStream], value: int) -> bool = c.SDL_WriteS32BE
public foreign function write_u_64le(dst: ptr[IOStream], value: ptr_uint) -> bool = c.SDL_WriteU64LE
public foreign function write_s_64le(dst: ptr[IOStream], value: ptr_int) -> bool = c.SDL_WriteS64LE
public foreign function write_u_64be(dst: ptr[IOStream], value: ptr_uint) -> bool = c.SDL_WriteU64BE
public foreign function write_s_64be(dst: ptr[IOStream], value: ptr_int) -> bool = c.SDL_WriteS64BE
...
public foreign function load_wav(path: cstr, spec: ptr[AudioSpec], audio_buf: ptr[ptr[ubyte]], audio_len: ptr[uint]) -> bool = c.SDL_LoadWAV
...
public foreign function get_rect_and_line_intersection(rect: const_ptr[Rect], x_1: ptr[int], y_1: ptr[int], x_2: ptr[int], y_2: ptr[int]) -> bool = c.SDL_GetRectAndLineIntersection
...
public foreign function get_rect_and_line_intersection_float(rect: const_ptr[FRect], x_1: ptr[float], y_1: ptr[float], x_2: ptr[float], y_2: ptr[float]) -> bool = c.SDL_GetRectAndLineIntersectionFloat
...
public foreign function blit_surface_9grid(src: ptr[Surface], srcrect: const_ptr[Rect]?, left_width: int, right_width: int, top_height: int, bottom_height: int, scale: float, scale_mode: ScaleMode, dst: ptr[Surface], dstrect: const_ptr[Rect]?) -> bool = c.SDL_BlitSurface9Grid
...
public foreign function set_primary_selection_text(text: cstr) -> bool = c.SDL_SetPrimarySelectionText
...
public foreign function get_clipboard_data(mime_type: cstr, size: ptr[ptr_uint]) -> ptr[void]? = c.SDL_GetClipboardData
public foreign function has_clipboard_data(mime_type: cstr) -> bool = c.SDL_HasClipboardData
...
public foreign function has_sse_2() -> bool = c.SDL_HasSSE2
public foreign function has_sse_3() -> bool = c.SDL_HasSSE3
public foreign function has_sse_41() -> bool = c.SDL_HasSSE41
public foreign function has_sse_42() -> bool = c.SDL_HasSSE42
public foreign function has_avx() -> bool = c.SDL_HasAVX
public foreign function has_avx_2() -> bool = c.SDL_HasAVX2
public foreign function has_avx_512f() -> bool = c.SDL_HasAVX512F
...
public foreign function set_window_title(window: Window, title: cstr) -> bool = c.SDL_SetWindowTitle
...
public foreign function gl_get_proc_address(proc_: cstr) -> FunctionPointer? = c.SDL_GL_GetProcAddress
public foreign function egl_get_proc_address(proc_: cstr) -> FunctionPointer? = c.SDL_EGL_GetProcAddress
public foreign function gl_unload_library() -> void = c.SDL_GL_UnloadLibrary
public foreign function gl_extension_supported(extension: cstr) -> bool = c.SDL_GL_ExtensionSupported
...
public foreign function string_to_guid(pch_guid: cstr) -> GUID = c.SDL_StringToGUID
...
public foreign function get_joystick_guid_info(guid: GUID, vendor: ptr[ushort], product: ptr[ushort], version: ptr[ushort], crc_16: ptr[ushort]) -> void = c.SDL_GetJoystickGUIDInfo
...
public foreign function add_gamepad_mapping(mapping: cstr) -> int = c.SDL_AddGamepadMapping
public foreign function add_gamepad_mappings_from_io(src: ptr[IOStream], closeio: bool) -> int = c.SDL_AddGamepadMappingsFromIO
public foreign function add_gamepad_mappings_from_file(file: cstr) -> int = c.SDL_AddGamepadMappingsFromFile
...
public foreign function get_gamepad_type_from_string(str: cstr) -> GamepadType = c.SDL_GetGamepadTypeFromString
public foreign function get_gamepad_string_for_type(type_: GamepadType) -> cstr? = c.SDL_GetGamepadStringForType
public foreign function get_gamepad_axis_from_string(str: cstr) -> GamepadAxis = c.SDL_GetGamepadAxisFromString
...
public foreign function get_gamepad_button_from_string(str: cstr) -> GamepadButton = c.SDL_GetGamepadButtonFromString
...
public foreign function set_scancode_name(scancode: Scancode, name: cstr) -> bool = c.SDL_SetScancodeName
public foreign function get_scancode_name(scancode: Scancode) -> cstr = c.SDL_GetScancodeName
public foreign function get_scancode_from_name(name: cstr) -> Scancode = c.SDL_GetScancodeFromName
public foreign function get_key_name(key: uint) -> cstr = c.SDL_GetKeyName
public foreign function get_key_from_name(name: cstr) -> Keycode = c.SDL_GetKeyFromName
...
public foreign function poll_event(out event: Event) -> bool = c.SDL_PollEvent
public foreign function wait_event(event: ptr[Event]?) -> bool = c.SDL_WaitEvent
public foreign function wait_event_timeout(event: ptr[Event]?, timeout_ms: int) -> bool = c.SDL_WaitEventTimeout
public foreign function push_event(event: ptr[Event]) -> bool = c.SDL_PushEvent
...
public foreign function get_window_from_event(event: const_ptr[Event]) -> Window? = c.SDL_GetWindowFromEvent
public foreign function get_event_description(event: const_ptr[Event], buf: ptr[char], buflen: int) -> int = c.SDL_GetEventDescription
public foreign function get_base_path() -> cstr? = c.SDL_GetBasePath
public foreign function get_pref_path(org: cstr, app: cstr) -> ptr[char] = c.SDL_GetPrefPath
public foreign function get_user_folder(folder: Folder) -> cstr = c.SDL_GetUserFolder
public foreign function create_directory(path: cstr) -> bool = c.SDL_CreateDirectory
public foreign function enumerate_directory(path: cstr, callback: fn(arg0: ptr[void], arg1: cstr, arg2: cstr) -> EnumerationResult, userdata: ptr[void]) -> bool = c.SDL_EnumerateDirectory
public foreign function remove_path(path: cstr) -> bool = c.SDL_RemovePath
public foreign function rename_path(oldpath: cstr, newpath: cstr) -> bool = c.SDL_RenamePath
public foreign function copy_file(oldpath: cstr, newpath: cstr) -> bool = c.SDL_CopyFile
public foreign function get_path_info(path: cstr, info: ptr[PathInfo]?) -> bool = c.SDL_GetPathInfo
public foreign function glob_directory(path: cstr, pattern: cstr, flags_: uint, count: ptr[int]) -> ptr[ptr[char]]? = c.SDL_GlobDirectory
...
public foreign function set_gpu_buffer_name(device: ptr[GPUDevice], buffer: ptr[GPUBuffer], text: cstr) -> void = c.SDL_SetGPUBufferName
public foreign function set_gpu_texture_name(device: ptr[GPUDevice], texture: ptr[GPUTexture], text: cstr) -> void = c.SDL_SetGPUTextureName
public foreign function insert_gpu_debug_label(command_buffer: ptr[GPUCommandBuffer], text: cstr) -> void = c.SDL_InsertGPUDebugLabel
public foreign function push_gpu_debug_group(command_buffer: ptr[GPUCommandBuffer], name: cstr) -> void = c.SDL_PushGPUDebugGroup
...
public foreign function hid_open_path(path: cstr) -> ptr[hid_device]? = c.SDL_hid_open_path
...
public foreign function set_hint_with_priority(name: cstr, value: cstr, priority: HintPriority) -> bool = c.SDL_SetHintWithPriority
public foreign function set_hint(name: cstr, value: cstr) -> bool = c.SDL_SetHint
public foreign function reset_hint(name: cstr) -> bool = c.SDL_ResetHint
public foreign function reset_hints() -> void = c.SDL_ResetHints
public foreign function get_hint(name: cstr) -> cstr? = c.SDL_GetHint
public foreign function get_hint_boolean(name: cstr, default_value: bool) -> bool = c.SDL_GetHintBoolean
public foreign function add_hint_callback(name: cstr, callback: fn(arg0: ptr[void], arg1: cstr, arg2: cstr, arg3: cstr) -> void, userdata: ptr[void]) -> bool = c.SDL_AddHintCallback
public foreign function remove_hint_callback(name: cstr, callback: fn(arg0: ptr[void], arg1: cstr, arg2: cstr, arg3: cstr) -> void, userdata: ptr[void]) -> void = c.SDL_RemoveHintCallback
...
public foreign function set_app_metadata(app_name: str as cstr, app_version: str as cstr, app_identifier: str as cstr) -> bool = c.SDL_SetAppMetadata
public foreign function set_app_metadata_property(name: cstr, value: cstr?) -> bool = c.SDL_SetAppMetadataProperty
public foreign function get_app_metadata_property(name: cstr) -> cstr = c.SDL_GetAppMetadataProperty
public foreign function load_object(sofile: cstr) -> ptr[SharedObject]? = c.SDL_LoadObject
public foreign function load_function(handle: ptr[SharedObject], name: cstr) -> FunctionPointer? = c.SDL_LoadFunction
...
public foreign function log_message_v(category: int, priority: LogPriority, fmt: cstr, ap: va_list) -> void = c.SDL_LogMessageV
...
public foreign function show_simple_message_box(flags_: uint, title: cstr, message: cstr, window: Window?) -> bool = c.SDL_ShowSimpleMessageBox
...
public foreign function open_url(url: cstr) -> bool = c.SDL_OpenURL
...
public foreign function convert_event_to_render_coordinates(renderer: Renderer, inout event: Event) -> bool = c.SDL_ConvertEventToRenderCoordinates
...
public foreign function render_line(renderer: Renderer, x_1: float, y_1: float, x_2: float, y_2: float) -> bool = c.SDL_RenderLine
...
public foreign function render_texture_9grid(renderer: Renderer, texture: ptr[Texture], srcrect: const_ptr[FRect]?, left_width: float, right_width: float, top_height: float, bottom_height: float, scale: float, dstrect: const_ptr[FRect]?) -> bool = c.SDL_RenderTexture9Grid
public foreign function render_texture_9grid_tiled(renderer: Renderer, texture: ptr[Texture], srcrect: const_ptr[FRect]?, left_width: float, right_width: float, top_height: float, bottom_height: float, scale: float, dstrect: const_ptr[FRect]?, tile_scale: float) -> bool = c.SDL_RenderTexture9GridTiled
...
public foreign function open_title_storage(override: cstr, props: uint) -> ptr[Storage]? = c.SDL_OpenTitleStorage
public foreign function open_user_storage(org: cstr, app: cstr, props: uint) -> ptr[Storage]? = c.SDL_OpenUserStorage
...
public foreign function get_storage_file_size(storage: ptr[Storage], path: cstr, length: ptr[ptr_uint]) -> bool = c.SDL_GetStorageFileSize
public foreign function read_storage_file(storage: ptr[Storage], path: cstr, destination: ptr[void], length: ptr_uint) -> bool = c.SDL_ReadStorageFile
public foreign function write_storage_file(storage: ptr[Storage], path: cstr, source: const_ptr[void], length: ptr_uint) -> bool = c.SDL_WriteStorageFile
public foreign function create_storage_directory(storage: ptr[Storage], path: cstr) -> bool = c.SDL_CreateStorageDirectory
...
public foreign function remove_storage_path(storage: ptr[Storage], path: cstr) -> bool = c.SDL_RemoveStoragePath
public foreign function rename_storage_path(storage: ptr[Storage], oldpath: cstr, newpath: cstr) -> bool = c.SDL_RenameStoragePath
public foreign function copy_storage_file(storage: ptr[Storage], oldpath: cstr, newpath: cstr) -> bool = c.SDL_CopyStorageFile
public foreign function get_storage_path_info(storage: ptr[Storage], path: cstr, info: ptr[PathInfo]?) -> bool = c.SDL_GetStoragePathInfo
...
public foreign function create_tray(icon: ptr[Surface], tooltip: cstr) -> ptr[Tray] = c.SDL_CreateTray
...
public foreign function set_tray_tooltip(tray: ptr[Tray], tooltip: cstr) -> void = c.SDL_SetTrayTooltip
...
public foreign function set_tray_entry_label(entry: ptr[TrayEntry], label: cstr) -> void = c.SDL_SetTrayEntryLabel
