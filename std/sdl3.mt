...
public foreign function utf8strlen(str: str as cstr) -> ptr_uint = c.SDL_utf8strlen
public foreign function utf8strnlen(str: str as cstr, bytes: ptr_uint) -> ptr_uint = c.SDL_utf8strnlen
