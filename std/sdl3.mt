...
public foreign function strlen(str: str as cstr) -> ptr_uint = c.SDL_strlen
public foreign function strnlen(str: str as cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strnlen
public foreign function strlcpy(dst: ptr[char], src: str as cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strlcpy
public foreign function utf_8strlcpy(dst: ptr[char], src: str as cstr, dst_bytes: ptr_uint) -> ptr_uint = c.SDL_utf8strlcpy
public foreign function strlcat(dst: ptr[char], src: str as cstr, maxlen: ptr_uint) -> ptr_uint = c.SDL_strlcat
public foreign function strdup(str: str as cstr) -> ptr[char]? = c.SDL_strdup
public foreign function strndup(str: str as cstr, maxlen: ptr_uint) -> ptr[char] = c.SDL_strndup
...
public foreign function strchr(str: str as cstr, c: int) -> ptr[char]? = c.SDL_strchr
public foreign function strrchr(str: str as cstr, c: int) -> ptr[char]? = c.SDL_strrchr
...
public foreign function strtok_r(str: ptr[char]?, delim: str as cstr, saveptr: ptr[ptr[char]]) -> ptr[char]? = c.SDL_strtok_r
public foreign function utf_8strlen(str: str as cstr) -> ptr_uint = c.SDL_utf8strlen
public foreign function utf_8strnlen(str: str as cstr, bytes: ptr_uint) -> ptr_uint = c.SDL_utf8strnlen
...
public foreign function atoi(str: str as cstr) -> int = c.SDL_atoi
public foreign function atof(str: str as cstr) -> double = c.SDL_atof
public foreign function strtol(str: str as cstr, endp: ptr[ptr[char]], base: int) -> ptr_int = c.SDL_strtol
public foreign function strtoul(str: str as cstr, endp: ptr[ptr[char]], base: int) -> ptr_uint = c.SDL_strtoul
public foreign function strtoll(str: str as cstr, endp: ptr[ptr[char]], base: int) -> long = c.SDL_strtoll
public foreign function strtoull(str: str as cstr, endp: ptr[ptr[char]], base: int) -> ulong = c.SDL_strtoull
public foreign function strtod(str: str as cstr, endp: ptr[ptr[char]]) -> double = c.SDL_strtod
public foreign function strcmp(str_1: str as cstr, str_2: str as cstr) -> int = c.SDL_strcmp
public foreign function strncmp(str_1: str as cstr, str_2: str as cstr, maxlen: ptr_uint) -> int = c.SDL_strncmp
public foreign function strcasecmp(str_1: str as cstr, str_2: str as cstr) -> int = c.SDL_strcasecmp
public foreign function strncasecmp(str_1: str as cstr, str_2: str as cstr, maxlen: ptr_uint) -> int = c.SDL_strncasecmp
public foreign function strpbrk(str: str as cstr, breakset: str as cstr) -> ptr[char] = c.SDL_strpbrk
public foreign function step_utf_8(pstr: ptr[cstr], pslen: ptr[ptr_uint]?) -> uint = c.SDL_StepUTF8
public foreign function step_back_utf_8(start: str as cstr, pstr: ptr[cstr]) -> uint = c.SDL_StepBackUTF8
...
public foreign function get_gamepad_type_from_string(str: str as cstr) -> GamepadType = c.SDL_GetGamepadTypeFromString
public foreign function get_gamepad_string_for_type(type_: GamepadType) -> cstr? = c.SDL_GetGamepadStringForType
public foreign function get_gamepad_axis_from_string(str: str as cstr) -> GamepadAxis = c.SDL_GetGamepadAxisFromString
...
public foreign function get_gamepad_button_from_string(str: str as cstr) -> GamepadButton = c.SDL_GetGamepadButtonFromString
