...
extern module std.c.raygui:
    ...
    flags GuiTextAlignment: i32
        TEXT_ALIGN_LEFT = 0
        TEXT_ALIGN_CENTER = 1
        TEXT_ALIGN_RIGHT = 2

    flags GuiTextAlignmentVertical: i32
        TEXT_ALIGN_TOP = 0
        TEXT_ALIGN_MIDDLE = 1
        TEXT_ALIGN_BOTTOM = 2

    flags GuiTextWrapMode: i32
        TEXT_WRAP_NONE = 0
        TEXT_WRAP_CHAR = 1
        TEXT_WRAP_WORD = 2
    ...
    flags GuiToggleProperty: i32
        GROUP_PADDING = 16

    enum GuiSliderProperty: i32
        SLIDER_WIDTH = 16
        SLIDER_PADDING = 17

    enum GuiProgressBarProperty: i32
        PROGRESS_PADDING = 16
        PROGRESS_SIDE = 17

    enum GuiScrollBarProperty: i32
        ARROWS_SIZE = 16
        ARROWS_VISIBLE = 17
    ...
    flags GuiCheckBoxProperty: i32
        CHECK_PADDING = 16

    enum GuiComboBoxProperty: i32
        COMBO_BUTTON_WIDTH = 16
        COMBO_BUTTON_SPACING = 17

    enum GuiDropdownBoxProperty: i32
        ARROW_PADDING = 16
        DROPDOWN_ITEMS_SPACING = 17
        DROPDOWN_ARROW_HIDDEN = 18
        DROPDOWN_ROLL_UP = 19

    flags GuiTextBoxProperty: i32
        TEXT_READONLY = 16

    enum GuiValueBoxProperty: i32
        SPINNER_BUTTON_WIDTH = 16
        SPINNER_BUTTON_SPACING = 17

    enum GuiListViewProperty: i32
    ...
    enum GuiColorPickerProperty: i32
    ...
    const RAYGUI_VERSION_MINOR: i32 = 5

    const RAYGUI_VERSION_PATCH: i32 = 0

    const SCROLLBAR_LEFT_SIDE: i32 = 0

    const SCROLLBAR_RIGHT_SIDE: i32 = 1
