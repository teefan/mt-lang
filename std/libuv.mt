...
public foreign function udp_try_send_2(handle: ptr[uv_udp_t], count: uint, bufs: ptr[ptr[uv_buf_t]], nbufs: ptr[uint], addrs: ptr[ptr[sockaddr]], flags_: uint) -> int = c.uv_udp_try_send2
...
public foreign function pipe_bind_2(handle: ptr[uv_pipe_t], name: str as cstr, namelen: ptr_uint, flags_: uint) -> int = c.uv_pipe_bind2
...
public foreign function pipe_connect_2(req: ptr[uv_connect_t], handle: ptr[uv_pipe_t], name: str as cstr, namelen: ptr_uint, flags_: uint, cb: fn(arg0: ptr[uv_connect_t], arg1: int) -> void) -> int = c.uv_pipe_connect2
...
public foreign function fs_open(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, flags_: int, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_open
...
public foreign function fs_unlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_unlink
...
public foreign function fs_copyfile(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, new_path: str as cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_copyfile
public foreign function fs_mkdir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkdir
public foreign function fs_mkdtemp(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], tpl: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkdtemp
public foreign function fs_mkstemp(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], tpl: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkstemp
public foreign function fs_rmdir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_rmdir
public foreign function fs_scandir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_scandir
public foreign function fs_scandir_next(req: ptr[uv_fs_t], out ent: uv_dirent_t) -> int = c.uv_fs_scandir_next
public foreign function fs_opendir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_opendir
...
public foreign function fs_stat(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_stat
...
public foreign function fs_rename(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, new_path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_rename
...
public foreign function fs_access(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_access
public foreign function fs_chmod(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_chmod
public foreign function fs_utime(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, atime: double, mtime: double, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_utime
...
public foreign function fs_lutime(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, atime: double, mtime: double, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lutime
public foreign function fs_lstat(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lstat
public foreign function fs_link(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, new_path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_link
public foreign function fs_symlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, new_path: str as cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_symlink
public foreign function fs_readlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_readlink
public foreign function fs_realpath(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_realpath
...
public foreign function fs_chown(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, uid: uint, gid: uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_chown
...
public foreign function fs_lchown(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, uid: uint, gid: uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lchown
public foreign function fs_statfs(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: str as cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_statfs
...
public foreign function ip_4_addr(ip: str as cstr, port: int, out addr: sockaddr_in) -> int = c.uv_ip4_addr
public foreign function ip_6_addr(ip: str as cstr, port: int, out addr: sockaddr_in6) -> int = c.uv_ip6_addr
public foreign function ip_4_name(src: const_ptr[sockaddr_in], dst: ptr[char], size: ptr_uint) -> int = c.uv_ip4_name
public foreign function ip_6_name(src: const_ptr[sockaddr_in6], dst: ptr[char], size: ptr_uint) -> int = c.uv_ip6_name
...
public foreign function utf_16_to_wtf_8(utf_16: const_ptr[ushort], utf_16_len: ptr_int, out wtf_8_ptr: ptr[char]?, out wtf_8_len_ptr: ptr_uint) -> int = c.uv_utf16_to_wtf8
public foreign function wtf_8_length_as_utf_16(wtf_8: str as cstr) -> ptr_int = c.uv_wtf8_length_as_utf16
public foreign function wtf_8_to_utf_16(wtf_8: str as cstr, utf_16: ptr[ushort], utf_16_len: ptr_uint) -> void = c.uv_wtf8_to_utf16
