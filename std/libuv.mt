...
public foreign function loop_delete(arg_0: ptr[uv_loop_t]) -> void = c.uv_loop_delete
...
public foreign function run(arg_0: ptr[uv_loop_t], mode: uv_run_mode) -> int = c.uv_run
public foreign function stop(arg_0: ptr[uv_loop_t]) -> void = c.uv_stop
public foreign function ref(arg_0: ptr[uv_handle_t]) -> void = c.uv_ref
public foreign function unref(arg_0: ptr[uv_handle_t]) -> void = c.uv_unref
public foreign function has_ref(arg_0: const_ptr[uv_handle_t]) -> int = c.uv_has_ref
public foreign function update_time(arg_0: ptr[uv_loop_t]) -> void = c.uv_update_time
public foreign function now(arg_0: const_ptr[uv_loop_t]) -> ulong = c.uv_now
public foreign function backend_fd(arg_0: const_ptr[uv_loop_t]) -> int = c.uv_backend_fd
public foreign function backend_timeout(arg_0: const_ptr[uv_loop_t]) -> int = c.uv_backend_timeout
...
public foreign function send_buffer_size(handle: ptr[uv_handle_t], value: ptr[int]) -> int = c.uv_send_buffer_size
public foreign function recv_buffer_size(handle: ptr[uv_handle_t], value: ptr[int]) -> int = c.uv_recv_buffer_size
public foreign function fileno(handle: const_ptr[uv_handle_t], fd: ptr[uv_os_fd_t]) -> int = c.uv_fileno
...
public foreign function socketpair(type_: int, protocol: int, socket_vector: ptr[uv_os_sock_t], flags_0: int, flags_1: int) -> int = c.uv_socketpair
...
public foreign function read_start(arg_0: ptr[uv_stream_t], alloc_cb: fn(arg0: ptr[uv_handle_t], arg1: ptr_uint, arg2: ptr[uv_buf_t]) -> void, read_cb: fn(arg0: ptr[uv_stream_t], arg1: ptr_int, arg2: const_ptr[uv_buf_t]) -> void) -> int = c.uv_read_start
public foreign function read_stop(arg_0: ptr[uv_stream_t]) -> int = c.uv_read_stop
...
public foreign function write_2(req: ptr[uv_write_t], handle: ptr[uv_stream_t], bufs: const_ptr[uv_buf_t], nbufs: uint, send_handle: ptr[uv_stream_t], cb: fn(arg0: ptr[uv_write_t], arg1: int) -> void) -> int = c.uv_write2
public foreign function try_write(handle: ptr[uv_stream_t], bufs: const_ptr[uv_buf_t], nbufs: uint) -> int = c.uv_try_write
public foreign function try_write_2(handle: ptr[uv_stream_t], bufs: const_ptr[uv_buf_t], nbufs: uint, send_handle: ptr[uv_stream_t]) -> int = c.uv_try_write2
...
public foreign function tcp_init(arg_0: ptr[uv_loop_t], handle: ptr[uv_tcp_t]) -> int = c.uv_tcp_init
public foreign function tcp_init_ex(arg_0: ptr[uv_loop_t], handle: ptr[uv_tcp_t], flags_: uint) -> int = c.uv_tcp_init_ex
...
public foreign function tcp_bind(handle: ptr[uv_tcp_t], addr: const_ptr[sys.sockaddr], flags_: uint) -> int = c.uv_tcp_bind
public foreign function tcp_getsockname(handle: const_ptr[uv_tcp_t], name: ptr[sys.sockaddr], namelen: ptr[int]) -> int = c.uv_tcp_getsockname
public foreign function tcp_getpeername(handle: const_ptr[uv_tcp_t], name: ptr[sys.sockaddr], namelen: ptr[int]) -> int = c.uv_tcp_getpeername
...
public foreign function tcp_connect(req: ptr[uv_connect_t], handle: ptr[uv_tcp_t], addr: const_ptr[sys.sockaddr], cb: fn(arg0: ptr[uv_connect_t], arg1: int) -> void) -> int = c.uv_tcp_connect
public foreign function udp_init(arg_0: ptr[uv_loop_t], handle: ptr[uv_udp_t]) -> int = c.uv_udp_init
public foreign function udp_init_ex(arg_0: ptr[uv_loop_t], handle: ptr[uv_udp_t], flags_: uint) -> int = c.uv_udp_init_ex
...
public foreign function udp_bind(handle: ptr[uv_udp_t], addr: const_ptr[sys.sockaddr], flags_: uint) -> int = c.uv_udp_bind
public foreign function udp_connect(handle: ptr[uv_udp_t], addr: const_ptr[sys.sockaddr]) -> int = c.uv_udp_connect
public foreign function udp_getpeername(handle: const_ptr[uv_udp_t], name: ptr[sys.sockaddr], namelen: ptr[int]) -> int = c.uv_udp_getpeername
public foreign function udp_getsockname(handle: const_ptr[uv_udp_t], name: ptr[sys.sockaddr], namelen: ptr[int]) -> int = c.uv_udp_getsockname
public foreign function udp_set_membership(handle: ptr[uv_udp_t], multicast_addr: cstr, interface_addr: cstr, membership: uv_membership) -> int = c.uv_udp_set_membership
public foreign function udp_set_source_membership(handle: ptr[uv_udp_t], multicast_addr: cstr, interface_addr: cstr, source_addr: cstr, membership: uv_membership) -> int = c.uv_udp_set_source_membership
...
public foreign function udp_set_multicast_interface(handle: ptr[uv_udp_t], interface_addr: cstr) -> int = c.uv_udp_set_multicast_interface
...
public foreign function udp_send(req: ptr[uv_udp_send_t], handle: ptr[uv_udp_t], bufs: const_ptr[uv_buf_t], nbufs: uint, addr: const_ptr[sys.sockaddr], send_cb: fn(arg0: ptr[uv_udp_send_t], arg1: int) -> void) -> int = c.uv_udp_send
public foreign function udp_try_send(handle: ptr[uv_udp_t], bufs: const_ptr[uv_buf_t], nbufs: uint, addr: const_ptr[sys.sockaddr]) -> int = c.uv_udp_try_send
public foreign function udp_try_send_2(handle: ptr[uv_udp_t], count: uint, bufs: ptr[ptr[uv_buf_t]], nbufs: ptr[uint], addrs: ptr[ptr[sys.sockaddr]], flags_: uint) -> int = c.uv_udp_try_send2
public foreign function udp_recv_start(handle: ptr[uv_udp_t], alloc_cb: fn(arg0: ptr[uv_handle_t], arg1: ptr_uint, arg2: ptr[uv_buf_t]) -> void, recv_cb: fn(arg0: ptr[uv_udp_t], arg1: ptr_int, arg2: const_ptr[uv_buf_t], arg3: const_ptr[sys.sockaddr], arg4: uint) -> void) -> int = c.uv_udp_recv_start
...
public foreign function tty_init(arg_0: ptr[uv_loop_t], arg_1: ptr[uv_tty_t], fd: int, readable: int) -> int = c.uv_tty_init
public foreign function tty_set_mode(arg_0: ptr[uv_tty_t], mode: uv_tty_mode_t) -> int = c.uv_tty_set_mode
public foreign function tty_reset_mode() -> int = c.uv_tty_reset_mode
public foreign function tty_get_winsize(arg_0: ptr[uv_tty_t], width: ptr[int], height: ptr[int]) -> int = c.uv_tty_get_winsize
...
public foreign function pipe_init(arg_0: ptr[uv_loop_t], handle: ptr[uv_pipe_t], ipc: int) -> int = c.uv_pipe_init
public foreign function pipe_open(arg_0: ptr[uv_pipe_t], file: int) -> int = c.uv_pipe_open
public foreign function pipe_bind(handle: ptr[uv_pipe_t], name: cstr) -> int = c.uv_pipe_bind
public foreign function pipe_bind_2(handle: ptr[uv_pipe_t], name: cstr, namelen: ptr_uint, flags_: uint) -> int = c.uv_pipe_bind2
public foreign function pipe_connect(req: ptr[uv_connect_t], handle: ptr[uv_pipe_t], name: cstr, cb: fn(arg0: ptr[uv_connect_t], arg1: int) -> void) -> void = c.uv_pipe_connect
public foreign function pipe_connect_2(req: ptr[uv_connect_t], handle: ptr[uv_pipe_t], name: cstr, namelen: ptr_uint, flags_: uint, cb: fn(arg0: ptr[uv_connect_t], arg1: int) -> void) -> int = c.uv_pipe_connect2
public foreign function pipe_getsockname(handle: const_ptr[uv_pipe_t], buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_pipe_getsockname
public foreign function pipe_getpeername(handle: const_ptr[uv_pipe_t], buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_pipe_getpeername
...
public foreign function prepare_init(arg_0: ptr[uv_loop_t], prepare: ptr[uv_prepare_t]) -> int = c.uv_prepare_init
...
public foreign function check_init(arg_0: ptr[uv_loop_t], check: ptr[uv_check_t]) -> int = c.uv_check_init
...
public foreign function idle_init(arg_0: ptr[uv_loop_t], idle: ptr[uv_idle_t]) -> int = c.uv_idle_init
...
public foreign function async_init(arg_0: ptr[uv_loop_t], async_: ptr[uv_async_t], async_cb: fn(arg0: ptr[uv_async_t]) -> void) -> int = c.uv_async_init
public foreign function async_send(async_: ptr[uv_async_t]) -> int = c.uv_async_send
public foreign function timer_init(arg_0: ptr[uv_loop_t], handle: ptr[uv_timer_t]) -> int = c.uv_timer_init
...
public foreign function getaddrinfo(loop: ptr[uv_loop_t], req: ptr[uv_getaddrinfo_t], getaddrinfo_cb: fn(arg0: ptr[uv_getaddrinfo_t], arg1: int, arg2: ptr[sys.addrinfo]) -> void, node: cstr, service: cstr, hints: const_ptr[sys.addrinfo]) -> int = c.uv_getaddrinfo
public foreign function freeaddrinfo(ai: ptr[sys.addrinfo]) -> void = c.uv_freeaddrinfo
public foreign function getnameinfo(loop: ptr[uv_loop_t], req: ptr[uv_getnameinfo_t], getnameinfo_cb: fn(arg0: ptr[uv_getnameinfo_t], arg1: int, arg2: cstr, arg3: cstr) -> void, addr: const_ptr[sys.sockaddr], flags_: int) -> int = c.uv_getnameinfo
...
public foreign function process_kill(arg_0: ptr[uv_process_t], signum: int) -> int = c.uv_process_kill
public foreign function kill(pid: int, signum: int) -> int = c.uv_kill
public foreign function process_get_pid(arg_0: const_ptr[uv_process_t]) -> uv_pid_t = c.uv_process_get_pid
...
public foreign function set_process_title(title: cstr) -> int = c.uv_set_process_title
public foreign function resident_set_memory(rss: ptr[ptr_uint]) -> int = c.uv_resident_set_memory
public foreign function uptime(uptime: ptr[double]) -> int = c.uv_uptime
...
public foreign function getrusage(rusage: ptr[uv_rusage_t]) -> int = c.uv_getrusage
public foreign function getrusage_thread(rusage: ptr[uv_rusage_t]) -> int = c.uv_getrusage_thread
public foreign function os_homedir(buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_os_homedir
public foreign function os_tmpdir(buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_os_tmpdir
...
public foreign function os_get_passwd_2(pwd: ptr[uv_passwd_t], uid: uint) -> int = c.uv_os_get_passwd2
...
public foreign function os_getpriority(pid: int, priority: ptr[int]) -> int = c.uv_os_getpriority
public foreign function os_setpriority(pid: int, priority: int) -> int = c.uv_os_setpriority
public foreign function thread_getpriority(tid: ptr_uint, priority: ptr[int]) -> int = c.uv_thread_getpriority
...
public foreign function cpu_info(cpu_infos: ptr[ptr[uv_cpu_info_t]], count: ptr[int]) -> int = c.uv_cpu_info
...
public foreign function interface_addresses(addresses: ptr[ptr[uv_interface_address_t]], count: ptr[int]) -> int = c.uv_interface_addresses
...
public foreign function os_environ(envitems: ptr[ptr[uv_env_item_t]], count: ptr[int]) -> int = c.uv_os_environ
public foreign function os_free_environ(envitems: ptr[uv_env_item_t], count: int) -> void = c.uv_os_free_environ
public foreign function os_getenv(name: cstr, buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_os_getenv
public foreign function os_setenv(name: cstr, value: cstr) -> int = c.uv_os_setenv
public foreign function os_unsetenv(name: cstr) -> int = c.uv_os_unsetenv
public foreign function os_gethostname(buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_os_gethostname
public foreign function os_uname(buffer: ptr[uv_utsname_t]) -> int = c.uv_os_uname
public foreign function metrics_info(loop: ptr[uv_loop_t], metrics: ptr[uv_metrics_t]) -> int = c.uv_metrics_info
public foreign function metrics_idle_time(loop: ptr[uv_loop_t]) -> ulong = c.uv_metrics_idle_time
public foreign function fs_get_type(arg_0: const_ptr[uv_fs_t]) -> uv_fs_type = c.uv_fs_get_type
public foreign function fs_get_result(arg_0: const_ptr[uv_fs_t]) -> ptr_int = c.uv_fs_get_result
public foreign function fs_get_system_error(arg_0: const_ptr[uv_fs_t]) -> int = c.uv_fs_get_system_error
public foreign function fs_get_ptr(arg_0: const_ptr[uv_fs_t]) -> ptr[void] = c.uv_fs_get_ptr
public foreign function fs_get_path(arg_0: const_ptr[uv_fs_t]) -> cstr = c.uv_fs_get_path
public foreign function fs_get_statbuf(arg_0: ptr[uv_fs_t]) -> ptr[uv_stat_t] = c.uv_fs_get_statbuf
public foreign function fs_req_cleanup(req: ptr[uv_fs_t]) -> void = c.uv_fs_req_cleanup
public foreign function fs_close(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_close
public foreign function fs_open(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, flags_: int, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_open
public foreign function fs_read(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, bufs: const_ptr[uv_buf_t], nbufs: uint, offset: ptr_int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_read
public foreign function fs_unlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_unlink
public foreign function fs_write(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, bufs: const_ptr[uv_buf_t], nbufs: uint, offset: ptr_int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_write
public foreign function fs_copyfile(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, new_path: cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_copyfile
public foreign function fs_mkdir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkdir
public foreign function fs_mkdtemp(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], tpl: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkdtemp
public foreign function fs_mkstemp(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], tpl: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_mkstemp
public foreign function fs_rmdir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_rmdir
public foreign function fs_scandir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_scandir
public foreign function fs_scandir_next(req: ptr[uv_fs_t], ent: ptr[uv_dirent_t]) -> int = c.uv_fs_scandir_next
public foreign function fs_opendir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_opendir
public foreign function fs_readdir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], dir: ptr[uv_dir_t], cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_readdir
public foreign function fs_closedir(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], dir: ptr[uv_dir_t], cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_closedir
public foreign function fs_stat(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_stat
public foreign function fs_fstat(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_fstat
public foreign function fs_rename(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, new_path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_rename
public foreign function fs_fsync(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_fsync
public foreign function fs_fdatasync(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_fdatasync
public foreign function fs_ftruncate(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, offset: ptr_int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_ftruncate
public foreign function fs_sendfile(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], out_fd: int, in_fd: int, in_offset: ptr_int, length: ptr_uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_sendfile
public foreign function fs_access(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_access
public foreign function fs_chmod(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_chmod
public foreign function fs_utime(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, atime: double, mtime: double, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_utime
public foreign function fs_futime(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, atime: double, mtime: double, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_futime
public foreign function fs_lutime(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, atime: double, mtime: double, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lutime
public foreign function fs_lstat(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lstat
public foreign function fs_link(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, new_path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_link
public foreign function fs_symlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, new_path: cstr, flags_: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_symlink
public foreign function fs_readlink(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_readlink
public foreign function fs_realpath(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_realpath
public foreign function fs_fchmod(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, mode: int, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_fchmod
public foreign function fs_chown(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, uid: uint, gid: uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_chown
public foreign function fs_fchown(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], file: int, uid: uint, gid: uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_fchown
public foreign function fs_lchown(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, uid: uint, gid: uint, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_lchown
public foreign function fs_statfs(loop: ptr[uv_loop_t], req: ptr[uv_fs_t], path: cstr, cb: fn(arg0: ptr[uv_fs_t]) -> void) -> int = c.uv_fs_statfs
public foreign function fs_poll_init(loop: ptr[uv_loop_t], handle: ptr[uv_fs_poll_t]) -> int = c.uv_fs_poll_init
public foreign function fs_poll_start(handle: ptr[uv_fs_poll_t], poll_cb: fn(arg0: ptr[uv_fs_poll_t], arg1: int, arg2: const_ptr[uv_stat_t], arg3: const_ptr[uv_stat_t]) -> void, path: cstr, interval: uint) -> int = c.uv_fs_poll_start
public foreign function fs_poll_stop(handle: ptr[uv_fs_poll_t]) -> int = c.uv_fs_poll_stop
public foreign function fs_poll_getpath(handle: ptr[uv_fs_poll_t], buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_fs_poll_getpath
...
public foreign function fs_event_start(handle: ptr[uv_fs_event_t], cb: fn(arg0: ptr[uv_fs_event_t], arg1: cstr, arg2: int, arg3: int) -> void, path: cstr, flags_: uint) -> int = c.uv_fs_event_start
public foreign function fs_event_stop(handle: ptr[uv_fs_event_t]) -> int = c.uv_fs_event_stop
public foreign function fs_event_getpath(handle: ptr[uv_fs_event_t], buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_fs_event_getpath
public foreign function ip_4_addr(ip: cstr, port: int, addr: ptr[sys.sockaddr_in]) -> int = c.uv_ip4_addr
public foreign function ip_6_addr(ip: cstr, port: int, addr: ptr[sys.sockaddr_in6]) -> int = c.uv_ip6_addr
public foreign function ip_4_name(src: const_ptr[sys.sockaddr_in], dst: ptr[char], size: ptr_uint) -> int = c.uv_ip4_name
public foreign function ip_6_name(src: const_ptr[sys.sockaddr_in6], dst: ptr[char], size: ptr_uint) -> int = c.uv_ip6_name
public foreign function ip_name(src: const_ptr[sys.sockaddr], dst: ptr[char], size: ptr_uint) -> int = c.uv_ip_name
public foreign function inet_ntop(af: int, src: const_ptr[void], dst: ptr[char], size: ptr_uint) -> int = c.uv_inet_ntop
public foreign function inet_pton(af: int, src: cstr, dst: ptr[void]) -> int = c.uv_inet_pton
...
public foreign function if_indextoname(ifindex: uint, buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_if_indextoname
public foreign function if_indextoiid(ifindex: uint, buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_if_indextoiid
public foreign function exepath(buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_exepath
public foreign function cwd(buffer: ptr[char], size: ptr[ptr_uint]) -> int = c.uv_cwd
public foreign function chdir(dir: cstr) -> int = c.uv_chdir
...
public foreign function clock_gettime(clock_id: uv_clock_id, ts: ptr[uv_timespec64_t]) -> int = c.uv_clock_gettime
...
public foreign function dlopen(filename: cstr, lib: ptr[uv_lib_t]) -> int = c.uv_dlopen
public foreign function dlclose(lib: ptr[uv_lib_t]) -> void = c.uv_dlclose
public foreign function dlsym(lib: ptr[uv_lib_t], name: cstr, ptr: ptr[ptr[void]]) -> int = c.uv_dlsym
...
public foreign function gettimeofday(tv: ptr[uv_timeval64_t]) -> int = c.uv_gettimeofday
...
public foreign function thread_equal(t_1: const_ptr[uv_thread_t], t_2: const_ptr[uv_thread_t]) -> int = c.uv_thread_equal
public foreign function thread_setname(name: cstr) -> int = c.uv_thread_setname
public foreign function thread_getname(tid: ptr[uv_thread_t], name: ptr[char], size: ptr_uint) -> int = c.uv_thread_getname
public foreign function loop_get_data(arg_0: const_ptr[uv_loop_t]) -> ptr[void] = c.uv_loop_get_data
public foreign function loop_set_data(arg_0: ptr[uv_loop_t], data: ptr[void]) -> void = c.uv_loop_set_data
public foreign function utf_16_length_as_wtf_8(utf_16: const_ptr[ushort], utf_16_len: ptr_int) -> ptr_uint = c.uv_utf16_length_as_wtf8
public foreign function utf_16_to_wtf_8(utf_16: const_ptr[ushort], utf_16_len: ptr_int, wtf_8_ptr: ptr[ptr[char]], wtf_8_len_ptr: ptr[ptr_uint]) -> int = c.uv_utf16_to_wtf8
public foreign function wtf_8_length_as_utf_16(wtf_8: cstr) -> ptr_int = c.uv_wtf8_length_as_utf16
public foreign function wtf_8_to_utf_16(wtf_8: cstr, utf_16: ptr[ushort], utf_16_len: ptr_uint) -> void = c.uv_wtf8_to_utf16
