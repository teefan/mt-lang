...
public foreign function parse_with_opts(value: cstr, return_parse_end: ptr[cstr], require_null_terminated: int) -> ptr[JSON]? = c.cJSON_ParseWithOpts
public foreign function parse_with_length_opts(value: cstr, buffer_length: ptr_uint, return_parse_end: ptr[cstr], require_null_terminated: int) -> ptr[JSON]? = c.cJSON_ParseWithLengthOpts
...
public foreign function has_object_item(object: const_ptr[JSON], string: cstr) -> Bool = c.cJSON_HasObjectItem
...
public foreign function create_string(string: cstr) -> ptr[JSON]? = c.cJSON_CreateString
public foreign function create_raw(raw: cstr) -> ptr[JSON]? = c.cJSON_CreateRaw
...
public foreign function create_string_reference(string: cstr) -> ptr[JSON]? = c.cJSON_CreateStringReference
...
public foreign function add_item_to_object(object: ptr[JSON], string: cstr, item: ptr[JSON]) -> Bool = c.cJSON_AddItemToObject
public foreign function add_item_to_object_cs(object: ptr[JSON], string: cstr, item: ptr[JSON]) -> Bool = c.cJSON_AddItemToObjectCS
public foreign function add_item_reference_to_array(array: ptr[JSON], item: ptr[JSON]) -> Bool = c.cJSON_AddItemReferenceToArray
public foreign function add_item_reference_to_object(object: ptr[JSON], string: cstr, item: ptr[JSON]) -> Bool = c.cJSON_AddItemReferenceToObject
...
public foreign function detach_item_from_object(object: ptr[JSON], string: cstr) -> ptr[JSON]? = c.cJSON_DetachItemFromObject
public foreign function detach_item_from_object_case_sensitive(object: ptr[JSON], string: cstr) -> ptr[JSON]? = c.cJSON_DetachItemFromObjectCaseSensitive
public foreign function delete_item_from_object(object: ptr[JSON], string: cstr) -> void = c.cJSON_DeleteItemFromObject
public foreign function delete_item_from_object_case_sensitive(object: ptr[JSON], string: cstr) -> void = c.cJSON_DeleteItemFromObjectCaseSensitive
...
public foreign function replace_item_in_object(object: ptr[JSON], string: cstr, newitem: ptr[JSON]) -> Bool = c.cJSON_ReplaceItemInObject
public foreign function replace_item_in_object_case_sensitive(object: ptr[JSON], string: cstr, newitem: ptr[JSON]) -> Bool = c.cJSON_ReplaceItemInObjectCaseSensitive
...
public foreign function add_null_to_object(object: ptr[JSON], name: cstr) -> ptr[JSON]? = c.cJSON_AddNullToObject
public foreign function add_true_to_object(object: ptr[JSON], name: cstr) -> ptr[JSON]? = c.cJSON_AddTrueToObject
public foreign function add_false_to_object(object: ptr[JSON], name: cstr) -> ptr[JSON]? = c.cJSON_AddFalseToObject
public foreign function add_bool_to_object(object: ptr[JSON], name: cstr, boolean: int) -> ptr[JSON]? = c.cJSON_AddBoolToObject
public foreign function add_number_to_object(object: ptr[JSON], name: cstr, number: double) -> ptr[JSON]? = c.cJSON_AddNumberToObject
...
public foreign function add_object_to_object(object: ptr[JSON], name: cstr) -> ptr[JSON]? = c.cJSON_AddObjectToObject
public foreign function add_array_to_object(object: ptr[JSON], name: cstr) -> ptr[JSON]? = c.cJSON_AddArrayToObject
public foreign function set_number_helper(object: ptr[JSON], number: double) -> double = c.cJSON_SetNumberHelper
public foreign function set_valuestring(object: ptr[JSON], valuestring: cstr) -> ptr[char] = c.cJSON_SetValuestring
