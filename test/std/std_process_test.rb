  ...
  def test_capture_with_env_and_cwd
    ...
    Dir.mktmpdir("milk-tea-std-process-capture") do |dir|
      source = [
        ...
        "",
        "    match process.capture_with_env(command.as_span(), maybe.Maybe[str].some(value= \"#{dir}\"), environment.as_span()):",
        ...
        "                maybe.Maybe.some as stdout_payload:",
        "                    if not stdout_payload.value.equal(\"#{dir}\\n\"):",
        "                        return 3",
        "                maybe.Maybe.none:",
        "                    return 4",
        "            match result.stderr_text():",
        "                maybe.Maybe.some as stderr_payload:",
