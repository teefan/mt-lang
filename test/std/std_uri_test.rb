...
class MilkTeaStdUriTest < Minitest::Test
  def test_host_runtime_executes_file_uri_encode_decode_helpers
    ...
    source = [
      ...
      "                return 8",
      "",
      "    if not maybe.is_none(uri.path_from_file_uri(\"https://example.invalid/tmp/main.mt\")):",
      "        return 9",
      "    if not maybe.is_none(uri.path_from_file_uri(\"file:///tmp/%ZZ\")):",
      "        return 10",
      "    if not maybe.is_none(uri.path_from_file_uri(\"file:///tmp/%F0%28%8C%28\")):",
      "        return 11",
      "",
      "    return 0",
      "",
