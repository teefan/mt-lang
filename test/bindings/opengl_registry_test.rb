...
class MilkTeaOpenGLRegistryTest < Minitest::Test
  ...
  def test_generated_header_is_bindgen_compatible
    ...
    Dir.mktmpdir("milk-tea-opengl-registry") do |dir|
      ...
      assert_match(/type GLenum = uint/, generated)
      assert_match(/external function glBegin\(mode: uint\) -> void/, generated)
      assert_match(/external function glBindBuffer\(target: uint, buffer: uint\) -> void/, generated)
      ...
      assert_equal "gl", analysis.module_name
