  ...
  def test_run_with_host_compiler_executes_program_using_status_construction
    ...
    Dir.mktmpdir("milk-tea-run-result") do |dir|
      ...
      File.write(source_path, [
        ...
        "    invalid_format = 1",
        "",
        "function load(available: bool) -> status.Status[int, LoadError]:",
        "    if available:",
  ...
  def test_run_with_host_compiler_executes_program_using_status_values
    ...
    Dir.mktmpdir("milk-tea-run-result") do |dir|
      ...
      File.write(source_path, [
        ...
        "    invalid = 2",
        "",
        "function parse(flag: int) -> status.Status[int, ParseError]:",
        "    if flag == 0:",
        ...
        "",
        "function value_or_code(result: status.Status[int, ParseError]) -> int:",
        "    match result:",
