...
class MilkTeaStdLibuvRuntimeTest < Minitest::Test
  ...
  def test_host_runtime_executes_libuv_tcp_helpers
    ...
    source = [
      ...
      "        accepted = -10",
      "        return",
      "    let maybe_client = client_handle",
      "    if maybe_client == null:",
      "        accepted = -20",
      "        return",
      "    unsafe:",
      "        let client = cast[ptr[uv.uv_tcp_t]](maybe_client)",
      "        if uv.accept(server, cast[ptr[uv.uv_stream_t]](client)) != 0:",
      "            accepted = -30",
      "            return",
      "        uv.close(cast[ptr[uv.uv_handle_t]](client), on_close)",
      "    accepted = 1",
      "    unsafe:",
      "        uv.close(cast[ptr[uv.uv_handle_t]](server), on_close)",
      "    return",
      "",
      "def main() -> i32:",
